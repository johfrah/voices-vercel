...
CREATE TYPE "public"."studio_feedback_type" AS ENUM('text', 'audio', 'waveform_marker');--> statement-breakpoint
CREATE TYPE "public"."studio_session_status" AS ENUM('active', 'archived', 'completed');--> statement-breakpoint
...
CREATE TABLE "actors" (
	...
	"location" text,
	"clients" text,
	"delivery_date_min" timestamp,
	"delivery_date_min_priority" integer DEFAULT 0,
	"delivery_config" jsonb DEFAULT '{}'::jsonb,
	"photo_id" integer,
	"logo_id" integer,
	"voice_score" integer DEFAULT 10,
	"experience_level" "experience_level" DEFAULT 'pro',
	"experience_level_new" "experience_level" DEFAULT 'pro',
	...
	"average_delivery_time_hours" numeric(10, 2),
	"on_time_delivery_rate" numeric(5, 2),
	"delivery_penalty_days" integer DEFAULT 0,
...
CREATE TABLE "costs" (
	...
	"type" text NOT NULL,
	"journey" text DEFAULT 'studio' NOT NULL,
	"note" text,
	"workshop_edition_id" integer,
	"location_id" integer,
	"instructor_id" integer,
...
CREATE TABLE "orders" (
	...
	"is_manually_edited" boolean DEFAULT false,
	"vies_validated_at" timestamp,
	"vies_country_code" text,
	"ip_address" text,
	"created_at" timestamp DEFAULT now(),
...
CREATE TABLE "studio_feedback" (
	...
	"user_id" integer NOT NULL,
	"type" "studio_feedback_type" DEFAULT 'text' NOT NULL,
	"content" text NOT NULL,
	"audio_path" text,
...
CREATE TABLE "studio_sessions" (
	...
	"order_item_id" integer,
	"conversation_id" integer,
	"status" "studio_session_status" DEFAULT 'active',
...
CREATE TABLE "translations" (
	...
	"is_manually_edited" boolean DEFAULT false,
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "translations_key_lang_unique" UNIQUE("translation_key","lang")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" serial PRIMARY KEY NOT NULL,
...
ALTER TABLE "studio_feedback" ADD CONSTRAINT "studio_feedback_session_id_studio_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."studio_sessions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "studio_feedback" ADD CONSTRAINT "studio_feedback_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "studio_scripts" ADD CONSTRAINT "studio_scripts_session_id_studio_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."studio_sessions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "studio_sessions" ADD CONSTRAINT "studio_sessions_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "studio_sessions" ADD CONSTRAINT "studio_sessions_order_item_id_order_items_id_fk" FOREIGN KEY ("order_item_id") REFERENCES "public"."order_items"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "studio_sessions" ADD CONSTRAINT "studio_sessions_conversation_id_chat_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."chat_conversations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
