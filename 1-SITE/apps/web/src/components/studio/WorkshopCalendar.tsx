...
export const WorkshopCalendar: React.FC<{ workshops: any[] }> = ({ workshops }) => {
  ...
  return (
    <ContainerInstrument className="bg-white/40 backdrop-blur-md border border-white/20 rounded-[20px] p-8 shadow-aura group/calendar">
      <ContainerInstrument className="flex items-center justify-between mb-8">
        ...
        <ContainerInstrument className="flex gap-2">
          ...
          >
            <Image strokeWidth={1.5} src="/assets/common/branding/icons/BACK.svg" width={20} height={20} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.4 }} / />
          </ButtonInstrument>
          <ButtonInstrument 
            onClick={() => playClick('light')}
            className="w-10 h-10 rounded-[10px] bg-white border border-va-black/5 flex items-center justify-center text-va-black/40 hover:text-primary transition-all shadow-sm active:scale-95"
          >
            <Image strokeWidth={1.5} src="/assets/common/branding/icons/FORWARD.svg" width={20} height={20} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.4 }} / />
          </ButtonInstrument>
        </ContainerInstrument>
      </ContainerInstrument>
        ...
        {workshops.slice(0, 2).map((workshop, i) => (
          ...
          >
              ...
              <ContainerInstrument className="text-left">
                ...
                <ContainerInstrument className="flex items-center gap-3 mt-1">
                  <ContainerInstrument className="flex items-center gap-1 text-[15px] font-light text-va-black/30 tracking-widest ">
                    <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={10} height={10} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.4 }} / /> 10:00 - 17:00
                  </ContainerInstrument>
                  <ContainerInstrument className="flex items-center gap-1 text-[15px] font-light text-va-black/30 tracking-widest ">
                    <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={10} height={10} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.4 }} / /> 
            ...
            <ContainerInstrument className="flex items-center gap-2">
              <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={12} height={12} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.4 }} / />
