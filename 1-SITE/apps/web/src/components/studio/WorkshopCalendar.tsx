    ...
    <div className="bg-white/40 backdrop-blur-md border border-white/20 rounded-[40px] p-8 shadow-aura group/calendar">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-2xl font-black uppercase tracking-tight text-va-black">
              <VoiceglotText translationKey="studio.calendar.title" defaultText="Workshop Kalender" />
            </h3>
            <p className="text-[10px] font-black uppercase tracking-widest text-va-black/30 mt-1">
      ...
      <div className="grid grid-cols-7 gap-2 mb-8">
        {days.map(day => (
          <div key={day} className="text-center text-[10px] font-black uppercase tracking-widest text-va-black/20 py-2">
        ...
        {[...Array(28)].map((_, i) => {
          ...
          return (
            <div 
              ...
              className={`aspect-square rounded-xl flex items-center justify-center text-xs font-bold transition-all cursor-pointer active:scale-90 ${
                hasWorkshop 
      ...
      <div className="space-y-4">
        <h4 className="text-[10px] font-black uppercase tracking-widest text-va-black/30 mb-4">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-va-off-white flex flex-col items-center justify-center group-hover:bg-primary/10 transition-all">
                <span className="text-[8px] font-black uppercase text-va-black/30 group-hover:text-primary transition-all">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  <div className="flex items-center gap-1 text-[9px] font-bold text-va-black/30 uppercase tracking-widest">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black text-va-black/40 uppercase tracking-widest">6/8</span>
            </div>
          </div>
        ))}
      </div>
