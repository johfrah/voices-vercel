    ...
    <ContainerInstrument className="bg-white/40 backdrop-blur-md border border-white/20 rounded-[20px] p-8 shadow-aura group/calendar">
        ...
        <ContainerInstrument className="flex items-center gap-4">
          ...
          <ContainerInstrument>
            <HeadingInstrument level={3} className="text-2xl font-light tracking-tight text-va-black">
              <VoiceglotText strokeWidth={1.5} translationKey="studio.calendar.title" defaultText="Workshop kalender" / />
            </HeadingInstrument>
            <TextInstrument className="text-[15px] font-light tracking-widest text-va-black/30 mt-1 ">
              <VoiceglotText strokeWidth={1.5} translationKey="studio.calendar.month" defaultText="Februari 2026" / />
            </TextInstrument>
          </ContainerInstrument>
        </ContainerInstrument>
      ...
      <ContainerInstrument className="grid grid-cols-7 gap-2 mb-8">
        {days.map(day => (
          <TextInstrument key={day} className="text-center text-[15px] font-light tracking-widest text-va-black/20 py-2 ">
            <VoiceglotText strokeWidth={1.5} translationKey={`common.day.${day.toLowerCase()}`} defaultText={day} / />
          </TextInstrument>
        ))}
        {[...Array(28)].map((_, i) => {
          const day = i + 1;
      ...
      <ContainerInstrument className="space-y-4">
        <HeadingInstrument level={4} className="text-[15px] font-light tracking-widest text-va-black/40 mb-4 ">
          <VoiceglotText strokeWidth={1.5} translationKey="studio.calendar.upcoming" defaultText="Eerstvolgende Sessies" / />
        </HeadingInstrument>
            ...
            <ContainerInstrument className="flex items-center gap-4">
              <ContainerInstrument className="w-10 h-10 rounded-[10px] bg-va-off-white flex flex-col items-center justify-center group-hover:bg-primary/10 transition-all">
                <TextInstrument className="text-[15px] font-light text-va-black/30 group-hover:text-primary transition-all ">
                  <VoiceglotText strokeWidth={1.5} translationKey="common.month.feb.short" defaultText="FEB" / />
                </TextInstrument>
              ...
              <ContainerInstrument className="text-left">
                <HeadingInstrument level={5} className="text-[15px] font-light tracking-tight">
                  <VoiceglotText strokeWidth={1.5} translationKey={`workshop.${workshop.id}.title`} defaultText={workshop.title} noTranslate={true} / />
                </HeadingInstrument>
                <ContainerInstrument className="flex items-center gap-3 mt-1">
                  ...
                  <ContainerInstrument className="flex items-center gap-1 text-[15px] font-light text-va-black/30 tracking-widest ">
                    ...
                    <VoiceglotText strokeWidth={1.5} translationKey="common.location.brussels" defaultText="Studio Brussel" / />
                  </ContainerInstrument>
                </ContainerInstrument>
              </ContainerInstrument>
            </ContainerInstrument>
