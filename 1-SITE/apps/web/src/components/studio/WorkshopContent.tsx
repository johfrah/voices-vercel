  ...
  return (
    <BentoGrid strokeWidth={1.5} columns={3} className="mb-20">
      ...
      <BentoCard span="lg" className="relative group aspect-video md:aspect-auto bg-black overflow-hidden">
        {workshop.aftermovie_url ? (
          <ContainerInstrument className="absolute inset-0 flex items-center justify-center">
            <ContainerInstrument className="text-white/20 font-light tracking-tighter text-4xl group-hover:scale-110 transition-transform duration-700"><VoiceglotText strokeWidth={1.5} translationKey="workshop.aftermovie.label" defaultText="Aftermovie" / /></ContainerInstrument>
      ...
      <BentoCard span="sm" className="bg-va-black text-white p-10 flex flex-col justify-between rounded-[20px]">
        <ContainerInstrument>
          <ContainerInstrument className="text-[15px] font-light tracking-widest text-white/30 mb-8"><VoiceglotText strokeWidth={1.5} translationKey="workshop.instructor.label" defaultText="Jouw workshopgever" / /></ContainerInstrument>
          ...
          <HeadingInstrument level={4} className="text-2xl font-light tracking-tight mb-4 text-white"><VoiceglotText strokeWidth={1.5} translationKey={`workshop.${workshop.id}.instructor_name`} defaultText={workshop.instructeur || "Johfrah"} / /></HeadingInstrument>
        ...
        <ButtonInstrument className="text-[15px] font-light tracking-widest text-primary flex items-center gap-2 hover:gap-3 transition-all mt-8"><VoiceglotText strokeWidth={1.5} translationKey="workshop.instructor.action" defaultText="Meer over de workshopgever" / /><Image  src="/assets/common/branding/icons/FORWARD.svg" width={14} height={14} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / /></ButtonInstrument>
      </BentoCard>
    </BentoGrid>
  );
};
