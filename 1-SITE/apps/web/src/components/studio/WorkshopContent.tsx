  ...
  return (
    <BentoGrid columns={3} className="mb-20">
      ...
      <BentoCard span="sm" className="bg-va-black text-white p-10 flex flex-col justify-between rounded-[20px]">
        ...
        <ButtonInstrument className="text-[15px] font-light tracking-widest text-primary flex items-center gap-2 hover:gap-3 transition-all mt-8"><VoiceglotText translationKey="workshop.instructor.action" defaultText="Meer over de workshopgever" /><Image strokeWidth={1.5} src="/assets/common/branding/icons/FORWARD.svg" width={14} height={14} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / /></ButtonInstrument>
      </BentoCard>
    </BentoGrid>
  );
};
