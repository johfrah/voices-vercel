          ...
          <div className="flex items-start justify-between relative z-10">
            <div className="flex gap-4">
              <div className={`w-12 h-12 rounded-[10px] flex items-center justify-center transition-colors ${
                ...
                <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={24} height={24} alt="" className={state.upsells.workshop_home ? 'brightness-0 invert' : ''} style={!state.upsells.workshop_home ? { filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.4 } : {}} / />
              </div>
            ...
            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
              ...
              {state.upsells.workshop_home && <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={14} height={14} alt="" className="brightness-0 invert" / />}
            </div>
          </div>
          {/* Decorative background */}
          <div className="absolute -right-4 -bottom-4 opacity-[0.03] group-hover:scale-110 transition-transform duration-700">
            <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={120} height={120} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
          </div>
        </button>
      </div>
    </div>
