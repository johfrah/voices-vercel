    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-6 bg-va-black/60 backdrop-blur-xl animate-fade-in">
      <div className="w-full max-w-3xl bg-white rounded-[20px] shadow-aura overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-8 border-b border-black/5 flex justify-between items-center bg-va-off-white">
          ...
          >
            <Image strokeWidth={1.5} src="/assets/common/branding/icons/BACK.svg" width={24} height={24} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.2 }} / />
          </button>
        </div>
        ...
        <div className="p-8 bg-va-off-white border-t border-black/5 flex justify-between items-center">
          <div className="flex items-center gap-2 text-[15px] font-light tracking-widest text-va-black/30">
            <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={14} height={14} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)', opacity: 0.4 }} / />
          ...
          >
            Offerte verzenden <Image strokeWidth={1.5} src="/assets/common/branding/icons/FORWARD.svg" width={18} height={18} alt="" className="brightness-0 invert" / />
          </button>
        </div>
      </div>
    </div>
