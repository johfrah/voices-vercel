    ...
    <>
      ...
      >
        <div className="mt-4 flex gap-6">
          <div className="flex-1 p-6 bg-purple-50 rounded-3xl border border-purple-100">
            ...
            <button className="mt-4 flex items-center gap-2 text-[15px] font-bold text-purple-700 hover:underline">
      ...
      >
        <div className="mt-4 flex flex-col items-center text-center">
          ...
          <div className="text-[15px] font-medium text-slate-500 mb-4">
          ...
          <button className="w-full py-3 bg-slate-100 text-slate-400 rounded-xl font-bold text-[15px] cursor-not-allowed" disabled><VoiceglotText translationKey="order.workshop.certificate_download" defaultText="Download PDF" /></button>
        </div>
      </BentoCard>
    </>
  );
