      ...
      <ContainerInstrument className="mt-4 grid grid-cols-2 gap-4 text-[15px]">
        <ContainerInstrument className="p-3 bg-va-off-white rounded-[20px]">
          <TextInstrument className="text-va-black/20 text-[15px] font-light tracking-widest ">
            <VoiceglotText strokeWidth={1.5} translationKey="order.customer.company" defaultText="Bedrijf" / />
          </TextInstrument>
          <TextInstrument className="font-light">
            {company || <VoiceglotText strokeWidth={1.5} translationKey="common.private" defaultText="Privé" / />}
          </TextInstrument>
        </ContainerInstrument>
        <ContainerInstrument className="p-3 bg-va-off-white rounded-[20px]">
          <TextInstrument className="text-va-black/20 text-[15px] font-light tracking-widest ">
            <VoiceglotText strokeWidth={1.5} translationKey="order.customer.total_spent" defaultText="Total Spent" / />
          </TextInstrument>
