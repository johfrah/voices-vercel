    ...
    <BentoGrid className="mb-32">
      ...
      <BentoCard span="sm" className="bg-white p-8 flex flex-col justify-between h-[280px] border border-black/5 shadow-sm">
        <ContainerInstrument plain>
          ...
          <HeadingInstrument level={3} className="text-xl font-black tracking-tight mb-2 text-va-black"><VoiceglotText translationKey="academy.title" defaultText="Voices Academy" /><TextInstrument className="text-va-black/40 text-[15px] font-medium leading-relaxed"><VoiceglotText translationKey="academy.description" defaultText="Online leertrajecten voor wie op eigen tempo wil groeien als stemacteur." /></TextInstrument></HeadingInstrument>
        </ContainerInstrument>
      </BentoCard>
      ...
      <BentoCard span="sm" className="bg-va-dark-soft text-white p-8 flex flex-col justify-between h-[280px] border-none">
        <ContainerInstrument plain>
          ...
          <HeadingInstrument level={3} className="text-xl font-black tracking-tight mb-2 text-primary"><VoiceglotText translationKey="studio.calendar.title" defaultText="Volgende Sessies" /><TextInstrument className="text-white/60 text-[15px] font-medium leading-relaxed"><VoiceglotText translationKey="studio.calendar.description" defaultText="Bekijk de data voor 'Perfect spreken' en 'Voice-overs voor beginners'." /></TextInstrument></HeadingInstrument>
        </ContainerInstrument>
      </BentoCard>
      ...
      <BentoCard span="sm" className="bg-primary text-va-black p-8 flex flex-col justify-between h-[280px] border-none">
        <ContainerInstrument plain>
          ...
          <HeadingInstrument level={3} className="text-xl font-black tracking-tight mb-2"><VoiceglotText translationKey="studio.quiz.title" defaultText="Welke Workshop?" /><TextInstrument className="text-va-black/60 text-[15px] font-medium leading-relaxed"><VoiceglotText translationKey="studio.quiz.description" defaultText="Doe de interactieve video-quiz en ontdek jouw ideale traject." /></TextInstrument></HeadingInstrument>
        </ContainerInstrument>
      </BentoCard>
    </BentoGrid>
  );
