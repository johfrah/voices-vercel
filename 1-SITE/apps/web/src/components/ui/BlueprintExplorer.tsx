      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 bg-white rounded-[40px] p-8 md:p-12 border border-black/5 shadow-aura overflow-hidden relative">
        <div className="lg:col-span-2 space-y-8">
          <div className="space-y-2">
            <h3 className="text-2xl font-black uppercase tracking-tight">{selected.title}</h3>
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center gap-1.5 text-[9px] font-black uppercase tracking-widest text-va-black/30">
        ...
        <div className="space-y-6">
          <div className="bg-primary/5 p-6 rounded-[32px] border border-primary/10 space-y-4">
            <div className="flex items-center gap-2 text-primary">
              <Lightbulb size={18} />
              <h4 className="text-[10px] font-black uppercase tracking-widest text-primary">Schrijftip</h4>
            </div>
            <p className="text-[11px] font-medium text-va-black/60 leading-relaxed italic">
          ...
          <div className="p-6 bg-va-black rounded-[32px] text-white space-y-4">
            <p className="text-[9px] font-black uppercase tracking-[0.2em] text-white/40">Klaar om te laten inspreken?</p>
            <h4 className="text-lg font-black uppercase tracking-tight leading-none">Kies je stem</h4>
            <p className="text-[10px] text-white/60 leading-relaxed">Onze top-selectie van stemacteurs staat klaar om jouw unieke script tot leven te brengen.</p>
            <button className="w-full py-4 bg-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:scale-105 transition-all flex items-center justify-center gap-2">
