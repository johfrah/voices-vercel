    ...
    <ContainerInstrument className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
      ...
      <ContainerInstrument className="lg:col-span-2 space-y-8">
        <BentoCard span="full" className="bg-white p-12 shadow-aura border-black/5 overflow-visible">
          <ContainerInstrument className="flex items-center gap-4 mb-12">
            <ContainerInstrument className="w-10 h-10 rounded-full bg-va-black text-white flex items-center justify-center font-medium shadow-lg">
              {step}
            </ContainerInstrument>
            ...
            {step === 1 && (
              <ContainerInstrument className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <ContainerInstrument className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <ContainerInstrument className="space-y-2">
                    <TextInstrument as="label" className="text-[15px] font-medium tracking-widest text-va-black/30 ml-4">Familienaam</TextInstrument>
                    <InputInstrument 
                      value={formData.lastName}
                      onChange={(e) => handleInputChange('lastName', e.target.value)}
                      className="w-full px-6 py-5 rounded-[24px] bg-va-off-white border-none focus:ring-2 focus:ring-primary/20 transition-all font-medium" 
            ...
            {step === 2 && (
              <ContainerInstrument className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <ContainerInstrument className="space-y-2">
                  ...
                  <TextInstrument className="text-[15px] font-medium text-va-black/20 ml-4 tracking-widest">
                ...
                <ContainerInstrument className="flex gap-4">
                  <ButtonInstrument 
                    onClick={() => setStep(1)}
                    className="flex-1 py-6 rounded-[24px] bg-va-off-white text-va-black/40 text-[15px] font-medium tracking-widest hover:bg-va-black hover:text-white transition-all"
                  >
                    Terug
                  </ButtonInstrument>
                  <ButtonInstrument 
      ...
      <ContainerInstrument className="space-y-8 sticky top-32">
        <BentoCard span="sm" className="bg-va-black text-white p-10 shadow-aura-lg">
          <HeadingInstrument level={4} className="text-[15px] font-medium tracking-widest text-white/20 mb-8">
            Jouw Investering
          </HeadingInstrument>
          ...
          <ContainerInstrument className="space-y-6">
            <ContainerInstrument className="pb-6 border-b border-white/5">
              ...
              {item.date && (
                <TextInstrument className="text-[15px] font-medium text-primary tracking-widest">
                  {item.date}
                </TextInstrument>
              )}
            </ContainerInstrument>
            ...
            <ContainerInstrument className="space-y-3">
              <ContainerInstrument className="flex justify-between items-center text-[15px] font-medium">
            ...
            <ContainerInstrument className="pt-6 border-t border-white/10 flex justify-between items-end">
              <TextInstrument as="span" className="text-[15px] font-medium tracking-widest text-white/20">
                Totaal
              </TextInstrument>
