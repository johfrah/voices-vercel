          ...
          {type === 'quote' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between pb-6 border-b border-black/5">
                <h3 className="text-xl font-black tracking-tight"><VoiceglotText translationKey="auto.atomicactionpreview.bento_offerte_previe.50c62c" defaultText="Bento Offerte Preview" /></h3>
