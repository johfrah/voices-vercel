    ...
    <div className="space-y-6">
      ...
      {reasoning && (
        <div className="p-4 bg-primary/5 border border-primary/10 rounded-2xl">
          <p className="text-[15px] font-black tracking-widest text-primary mb-2"><VoiceglotText strokeWidth={1.5} translationKey="auto.atomicactionpreview.ai_redenering.23dd78" defaultText="AI Redenering" / /></p>
      ...
      <div className="bg-white border border-black/5 rounded-3xl overflow-hidden shadow-sm">
        <div className="p-4 bg-va-background border-b border-black/5 flex items-center justify-between">
          <span className="text-[15px] font-black tracking-widest opacity-40"><VoiceglotText strokeWidth={1.5} translationKey="auto.atomicactionpreview.concreet_resultaat.0ecf9f" defaultText="Concreet Resultaat" / /></span>
          <div className="flex gap-2">
            <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
            <span className="text-[15px] font-bold tracking-tight"><VoiceglotText strokeWidth={1.5} translationKey="auto.atomicactionpreview.klaar_voor_verzendin.4f7f40" defaultText="Klaar voor verzending" / /></span>
          </div>
        </div>
          ...
          {type === 'quote' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between pb-6 border-b border-black/5">
                <h3 className="text-xl font-black tracking-tight"><VoiceglotText strokeWidth={1.5} translationKey="auto.atomicactionpreview.bento_offerte_previe.50c62c" defaultText="Bento Offerte Preview" / /></h3>
                <span className="px-3 py-1 bg-primary text-white text-[15px] font-black rounded-full "><VoiceglotText strokeWidth={1.5} translationKey="auto.atomicactionpreview.interactief.8edbb5" defaultText="Interactief" / /></span>
              </div>
              ...
              <div className="p-4 bg-va-dark text-white rounded-2xl flex justify-between items-center">
                <span className="text-[15px] font-bold tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey="auto.atomicactionpreview.totaalbedrag.ca9253" defaultText="Totaalbedrag" / /></span>
