    ...
    <BentoGrid strokeWidth={1.5} className="mb-32">
      ...
      <BentoCard span="sm" className="bg-white p-8 flex flex-col justify-between h-[280px] border border-black/5 shadow-sm">
        <ContainerInstrument plain>
          ...
          <HeadingInstrument level={3} className="text-xl font-light tracking-tight mb-2 text-va-black"><VoiceglotText  translationKey="guarantees.pricing.title" defaultText="Eerlijke Prijs" /><TextInstrument className="text-va-black/40 text-[15px] font-medium leading-relaxed"><VoiceglotText  translationKey="guarantees.pricing.description" defaultText="Geen verborgen kosten of abonnementen. Je betaalt alleen voor wat je nodig hebt." /></TextInstrument></HeadingInstrument>
        </ContainerInstrument>
      </BentoCard>
      ...
      <BentoCard span="sm" className="bg-va-off-white p-8 flex flex-col justify-between h-[280px] border border-black/5 shadow-sm">
        <ContainerInstrument plain>
          ...
          <HeadingInstrument level={3} className="text-xl font-light tracking-tight mb-2 text-va-black"><VoiceglotText  translationKey="guarantees.archive.title" defaultText="Veilig Archief" /><TextInstrument className="text-va-black/40 text-[15px] font-medium leading-relaxed"><VoiceglotText  translationKey="guarantees.archive.description" defaultText="Al je scripts en opnames veilig bewaard in je persoonlijke kluis. Altijd bereikbaar." /></TextInstrument></HeadingInstrument>
        </ContainerInstrument>
      </BentoCard>
    </BentoGrid>
  );
