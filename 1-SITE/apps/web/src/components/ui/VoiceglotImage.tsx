      ...
      >
        <div 
          ...
          dangerouslySetInnerHTML={{ 
            __html: `
              <svg viewBox="0 0 3000 1179.28" class="w-full h-full" style="display: block; max-width: 100%; max-height: 100%;">
                <style>
                  .st0{fill:#FF2F8D;}
