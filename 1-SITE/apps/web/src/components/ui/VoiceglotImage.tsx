    ...
    <div className={cn("relative group/image-edit", isEditMode && "cursor-pointer")}>
      ...
      {isEditMode && (
        <>
          ...
          <div className="absolute -top-6 right-0 opacity-0 group-hover/image-edit:opacity-100 transition-opacity flex items-center gap-1 bg-va-black text-white px-2 py-0.5 rounded text-[8px] font-black uppercase tracking-widest pointer-events-none z-50 shadow-lg">
