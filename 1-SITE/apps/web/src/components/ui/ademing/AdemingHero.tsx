...
export const AdemingHero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-primary/10 py-32 px-6">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary/3 rounded-full blur-3xl animate-breathe-glow" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-3xl animate-breathe-glow" style={{ animationDelay: '-2s' }} />
      
      <div className="max-w-5xl mx-auto relative">
        <div className="text-center space-y-10">
          {/* Main heading - exact font and spacing */}
          <h1 className="text-5xl md:text-7xl font-serif font-bold leading-[1.1] text-foreground tracking-tight animate-fade-in">
            <VoiceglotText 
          ...
          <div className="flex justify-center pt-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <button 
              className="bg-primary text-white px-10 py-5 rounded-full text-xl font-medium shadow-soft hover:shadow-medium hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-3 group"
            >
          ...
          <div className="pt-12 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.8s' }}>
            <p className="text-lg italic text-muted-foreground/80 leading-relaxed font-serif">
              <VoiceglotText 
            ...
            <p className="mt-4 text-sm font-bold uppercase tracking-[0.2em] text-primary/60">
              <VoiceglotText 
