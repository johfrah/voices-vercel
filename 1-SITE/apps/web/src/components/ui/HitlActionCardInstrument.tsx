...
export const HitlActionCardInstrument = ({ 
  ...
  return (
    <ContainerInstrument className="bg-va-black text-white p-4 md:p-5 rounded-xl md:rounded-2xl shadow-aura border border-white/5 relative overflow-hidden group">
      {/* Background Glow */}
      ...
      <ContainerInstrument className="relative z-10">
        <HeadingInstrument level={3} className="text-[15px] md:text-[15px] font-medium mb-1 ">
          {title}
        </HeadingInstrument>
        <TextInstrument className="text-[15px] md:text-[15px] text-white/60 leading-relaxed mb-4 font-light">
          {description}
        </TextInstrument>

        <ButtonInstrument 
          onClick={onApprove}
          className="w-full py-2 md:py-3 bg-white text-va-black rounded-lg md:rounded-xl text-[15px] md:text-[15px] font-medium tracking-widest flex items-center justify-center gap-2 hover:bg-primary hover:text-white transition-all "
