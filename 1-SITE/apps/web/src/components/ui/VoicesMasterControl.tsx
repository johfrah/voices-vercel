...
export const VoicesMasterControl: React.FC<VoicesMasterControlProps> = ({ 
  ...
  // 🛡️ CHRIS-PROTOCOL: Map extra languages available for each primary language
    ...
    const languageConfig = [
      { label: MarketManager.getLanguageLabel('nl-be') || 'Vlaams', value: 1, langCode: 'nl-be', popular: market.popular_languages.includes('nl-be') || market.popular_languages.includes('Vlaams') },
      { label: MarketManager.getLanguageLabel('nl-nl') || 'Nederlands', value: 2, langCode: 'nl-nl', popular: market.popular_languages.includes('nl-nl') || market.popular_languages.includes('Nederlands') },
      { label: MarketManager.getLanguageLabel('fr-be') || 'Frans (BE)', value: 3, langCode: 'fr-be', popular: (market.popular_languages.includes('fr-be') || market.popular_languages.includes('Frans')) && market.market_code === 'BE' },
      { label: MarketManager.getLanguageLabel('fr-fr') || 'Frans (FR)', value: 4, langCode: 'fr-fr', popular: (market.popular_languages.includes('fr-fr') || market.popular_languages.includes('Frans')) && market.market_code !== 'BE' },
      { label: MarketManager.getLanguageLabel('en-gb') || 'Engels (UK)', value: 5, langCode: 'en-gb', popular: market.popular_languages.includes('en-gb') || market.popular_languages.includes('Engels') || market.popular_languages.includes('English') },
      { label: MarketManager.getLanguageLabel('en-us') || 'Engels (US)', value: 6, langCode: 'en-us', popular: false },
      { label: MarketManager.getLanguageLabel('de-de') || 'Duits', value: 7, langCode: 'de-de', popular: market.popular_languages.includes('de-de') || market.popular_languages.includes('Duits') || market.popular_languages.includes('German') },
      { label: MarketManager.getLanguageLabel('es-es') || 'Spaans', value: 8, langCode: 'es-es', popular: market.popular_languages.includes('es-es') || market.popular_languages.includes('Spaans') || market.popular_languages.includes('Spanish') },
      { label: MarketManager.getLanguageLabel('it-it') || 'Italiaans', value: 9, langCode: 'it-it', popular: market.popular_languages.includes('it-it') || market.popular_languages.includes('Italiaans') || market.popular_languages.includes('Italian') },
      { label: MarketManager.getLanguageLabel('pl-pl') || 'Pools', value: 10, langCode: 'pl-pl', popular: market.popular_languages.includes('pl-pl') || market.popular_languages.includes('Pools') || market.popular_languages.includes('Polish') },
      { label: MarketManager.getLanguageLabel('da-dk') || 'Deens', value: 11, langCode: 'da-dk', popular: market.popular_languages.includes('da-dk') || market.popular_languages.includes('Deens') || market.popular_languages.includes('Danish') },
      { label: MarketManager.getLanguageLabel('pt-pt') || 'Portugees', value: 12, langCode: 'pt-pt', popular: market.popular_languages.includes('pt-pt') || market.popular_languages.includes('Portugees') || market.popular_languages.includes('Portuguese') },
      { label: MarketManager.getLanguageLabel('sv-se') || 'Zweeds', value: 13, langCode: 'sv-se', popular: market.popular_languages.includes('sv-se') || market.popular_languages.includes('Zweeds') || market.popular_languages.includes('Swedish') },
    ];
