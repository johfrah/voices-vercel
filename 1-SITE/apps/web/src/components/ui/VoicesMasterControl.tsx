...
// 🛡️ CHRIS-PROTOCOL: Global UI Registry (v2.14.724)
// We define ContainerInstrument and TextInstrument if they are missing from imports
// to prevent ReferenceErrors in production builds.
