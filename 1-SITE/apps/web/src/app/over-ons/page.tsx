    ...
    <PageWrapperInstrument className="relative min-h-screen pt-32 pb-20 overflow-hidden">
      ...
      <SectionInstrument className="max-w-7xl mx-auto px-6 relative z-10">
        <ContainerInstrument className="text-center mb-20 space-y-6">
          ...
          <HeadingInstrument level={1} className="text-6xl md:text-8xl font-light tracking-tighter leading-none"><VoiceglotText translationKey="about.title_part1" defaultText="Het Vriendelijkste " /><TextInstrument as="span" className="text-primary font-extralight"><VoiceglotText translationKey="about.title_part2" defaultText="Stemmenbureau" /></TextInstrument></HeadingInstrument>
        </ContainerInstrument>
        ...
        <BentoGrid columns={3}>
          ...
          >
            <ContainerInstrument className="space-y-8">
              ...
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tight leading-none"><VoiceglotText translationKey="about.founder.title" defaultText="Wij geloven in de kracht van een warm geluid." /><TextInstrument className="text-va-black/60 font-light text-lg leading-relaxed"><VoiceglotText 
          ...
          >
            <ContainerInstrument className="space-y-6">
              <HeadingInstrument level={3} className="text-[15px] font-light tracking-[0.2em] text-white/20 "><VoiceglotText translationKey="about.values.label" defaultText="Onze Kernwaarden" /></HeadingInstrument>
              <ContainerInstrument className="space-y-4">
                {[
                  ...
                  <ContainerInstrument key={i} className="flex items-center gap-3">
                    ...
                    <TextInstrument className="text-[15px] font-light tracking-widest "><VoiceglotText translationKey={v.key} defaultText={v.text} /></TextInstrument>
                  </ContainerInstrument>
                ))}
              </ContainerInstrument>
            </ContainerInstrument>
          ...
          >
            ...
            <ContainerInstrument className="space-y-4">
              <HeadingInstrument level={2} className="text-3xl font-light tracking-tight"><VoiceglotText translationKey="about.mission.title" defaultText="Een stem die echt is en vertrouwen geeft." /><TextInstrument className="text-va-black/60 font-light text-lg"><VoiceglotText 
