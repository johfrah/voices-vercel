      ...
      <ContainerInstrument className="min-h-screen bg-va-off-white flex items-center justify-center p-6">
        <ContainerInstrument className="text-center space-y-8 max-w-md">
          ...
          <ContainerInstrument className="space-y-2">
            <HeadingInstrument level={1} className="text-4xl font-light tracking-tighter"><VoiceglotText strokeWidth={1.5} translationKey="checkout.empty.title" defaultText="Winkelmand leeg" / /><TextInstrument className="text-va-black/40 font-light"><VoiceglotText strokeWidth={1.5} translationKey="checkout.empty.text" defaultText="Je hebt nog geen stemmen geselecteerd voor je project." / /></TextInstrument></HeadingInstrument>
          </ContainerInstrument>
          <Link strokeWidth={1.5} href="/agency" className="va-btn-pro inline-block"><VoiceglotText strokeWidth={1.5} translationKey="checkout.empty.cta" defaultText="Ontdek stemmen" / /></Link>
        </ContainerInstrument>
      </ContainerInstrument>
    );
  }
        ...
        <ContainerInstrument className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <ContainerInstrument className="space-y-4">
            ...
            >
              ...
              <VoiceglotText strokeWidth={1.5} translationKey="checkout.back_to_agency" defaultText="Verder casten" / />
            </Link>
            <HeadingInstrument level={1} className="text-6xl md:text-8xl font-light tracking-tighter leading-none text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="checkout.title" defaultText="Checkout" / /></HeadingInstrument>
          </ContainerInstrument>
          <ContainerInstrument className="flex items-center gap-4">
            <ContainerInstrument className="px-4 py-2 bg-primary/5 text-primary rounded-[20px] text-[15px] font-light tracking-widest border border-primary/10 flex items-center gap-2">
              ...
              <VoiceglotText strokeWidth={1.5} translationKey="checkout.secure" defaultText="Secure checkout" / />
            </ContainerInstrument>
          </ContainerInstrument>
        </ContainerInstrument>
