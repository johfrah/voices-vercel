    ...
    <PageWrapperInstrument className="min-h-[80vh] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <ContainerInstrument className="max-w-2xl text-center space-y-8 relative z-10">
        <ContainerInstrument className="w-24 h-24 bg-green-500/10 text-green-500 rounded-[20px] flex items-center justify-center mx-auto animate-in zoom-in duration-700">
          <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={48} height={48} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
        </ContainerInstrument>
        ...
        <BentoGrid columns={2} className="pt-8">
          <BentoCard span="sm" className="bg-white border border-black/5 p-8 rounded-[20px] text-left space-y-4">
            <ContainerInstrument className="w-10 h-10 bg-primary/10 text-primary rounded-[10px] flex items-center justify-center">
              <Image strokeWidth={1.5} src="/assets/common/branding/icons/CART.svg" width={20} height={20} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
            </ContainerInstrument>
            ...
            <ButtonInstrument as={Link} href="/account/orders" className="text-[15px] font-light tracking-widest text-primary flex items-center gap-2 hover:gap-3 transition-all">
              ...
              <Image strokeWidth={1.5} src="/assets/common/branding/icons/FORWARD.svg" width={12} height={12} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
            </ButtonInstrument>
          </BentoCard>
        ...
        <ContainerInstrument className="pt-8">
          <Link strokeWidth={1.5} href="/" className="text-[15px] font-light tracking-widest text-va-black/20 hover:text-primary transition-colors"><VoiceglotText translationKey="checkout.success.back_home" defaultText="Terug naar de homepagina" /></Link>
        </ContainerInstrument>
    </PageWrapperInstrument>
  );
}
