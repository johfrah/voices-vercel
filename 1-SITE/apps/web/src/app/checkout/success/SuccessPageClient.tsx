    ...
    <PageWrapperInstrument className="min-h-[80vh] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <ContainerInstrument className="max-w-2xl text-center space-y-8 relative z-10">
        ...
        <ContainerInstrument className="space-y-2">
          <HeadingInstrument level={1} className="text-6xl md:text-7xl font-light tracking-tighter leading-none text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="checkout.success.title" defaultText="Gelukt!" / /><TextInstrument className="text-va-black/40 font-light text-[15px]"><VoiceglotText strokeWidth={1.5} 
        ...
        <ContainerInstrument className="bg-primary/5 p-4 rounded-[10px] inline-block">
          <TextInstrument className="text-[15px] font-light tracking-widest text-primary animate-pulse"><VoiceglotText strokeWidth={1.5} 
        ...
        <BentoGrid strokeWidth={1.5} columns={2} className="pt-8">
          <BentoCard span="sm" className="bg-white border border-black/5 p-8 rounded-[20px] text-left space-y-4">
            ...
            <HeadingInstrument level={3} className="text-xl font-light tracking-tight text-va-black">
              <VoiceglotText strokeWidth={1.5} translationKey="checkout.success.status.title" defaultText="Status" / />
            ...
            <ButtonInstrument as={Link} href="/account/orders" className="text-[15px] font-light tracking-widest text-primary flex items-center gap-2 hover:gap-3 transition-all">
              <VoiceglotText strokeWidth={1.5} translationKey="checkout.success.status.cta" defaultText="Mijn bestellingen" / />
          ...
          <BentoCard span="sm" className="bg-va-black text-white p-8 rounded-[20px] text-left space-y-4 relative overflow-hidden">
            ...
            <HeadingInstrument level={3} className="text-xl font-light tracking-tight relative z-10 text-white">
              <VoiceglotText strokeWidth={1.5} translationKey="checkout.success.next.title" defaultText="Volgende stap" / />
        ...
        <ContainerInstrument className="pt-8">
          <Link strokeWidth={1.5} href="/" className="text-[15px] font-light tracking-widest text-va-black/20 hover:text-primary transition-colors"><VoiceglotText strokeWidth={1.5} translationKey="checkout.success.back_home" defaultText="Terug naar de homepagina" / /></Link>
        </ContainerInstrument>
    </PageWrapperInstrument>
  );
}
