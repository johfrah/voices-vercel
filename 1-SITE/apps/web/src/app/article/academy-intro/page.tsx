      ...
      <SectionInstrument className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <BentoGrid columns={3}>
          ...
          >
            ...
            <HeadingInstrument level={2} className="text-3xl font-light tracking-tight mb-6 text-va-black ">
          ...
          <BentoCard span="sm" className="bg-va-black text-white p-12 !rounded-[20px]">
            ...
            <HeadingInstrument level={3} className="text-xl font-light tracking-tight mb-4 ">
          ...
          <BentoCard span="full" className="bg-va-off-white p-12 flex flex-col md:flex-row items-center gap-12 !rounded-[20px] border border-black/[0.03]">
            ...
            <ContainerInstrument>
              <HeadingInstrument level={3} className="text-2xl font-light tracking-tight mb-2 text-va-black ">
