    ...
    <PageWrapperInstrument className="relative min-h-screen pt-32 pb-20 overflow-hidden">
      ...
      <SectionInstrument className="max-w-6xl mx-auto px-6 relative z-10">
        <ContainerInstrument className="mb-12">
          ...
          <TextInstrument className="text-[15px] font-light tracking-[0.2em] text-primary mb-4 "><VoiceglotText translationKey="article.theme.experience" defaultText="Beleving" /></TextInstrument>
          <HeadingInstrument level={1} className="text-6xl font-light tracking-tighter leading-none mb-6 text-va-black "><VoiceglotText translationKey="music.title" defaultText="Wachtmuziek die werkt" /></HeadingInstrument>
        </ContainerInstrument>
        ...
        <BentoGrid columns={3}>
          ...
          <BentoCard span="md" className="bg-white shadow-aura p-12 !rounded-[20px]">
            ...
            <HeadingInstrument level={3} className="text-2xl font-light tracking-tight mb-4 text-va-black "><VoiceglotText translationKey="music.quality.title" defaultText="Geoptimaliseerd" /><TextInstrument className="text-va-black/60 font-light leading-relaxed"><VoiceglotText translationKey="music.quality.text" defaultText="Al onze muziek is technisch geoptimaliseerd voor telefonie (300Hz - 3400Hz). Geen vervorming, maar kristalhelder geluid." /></TextInstrument></HeadingInstrument>
          </BentoCard>
          ...
          <BentoCard span="md" className="bg-va-black text-white p-12 !rounded-[20px]">
            ...
            <HeadingInstrument level={3} className="text-2xl font-light tracking-tight mb-4 "><VoiceglotText translationKey="music.rights.title" defaultText="Rechtenvrij" /><TextInstrument className="text-white/60 font-light leading-relaxed"><VoiceglotText translationKey="music.rights.text" defaultText="Geen gedoe met Sabam of auteursrechten. Onze volledige bibliotheek is 100% rechtenvrij voor gebruik in jouw telefooncentrale." /></TextInstrument></HeadingInstrument>
          </BentoCard>
        </BentoGrid>
      </SectionInstrument>
    </PageWrapperInstrument>
