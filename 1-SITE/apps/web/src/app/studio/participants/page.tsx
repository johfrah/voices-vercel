    ...
    <PageWrapperInstrument className="max-w-7xl mx-auto px-6 py-20 relative z-10">
      ...
      <BentoGrid>
        ...
        <BentoCard span="sm" className="bg-va-black text-white p-8">
          ...
          <TextInstrument className="text-[10px] font-black uppercase tracking-widest text-white/40">
        ...
        <BentoCard span="sm" className="hblue text-white p-8">
          ...
          <TextInstrument className="text-[10px] font-black uppercase tracking-widest text-white/80">
        ...
        <BentoCard span="full" className="bg-white/40 backdrop-blur-md border-white/20 shadow-aura p-12">
            ...
            <ContainerInstrument className="flex items-center gap-4 w-full md:w-auto">
              <ContainerInstrument className="relative flex-1 md:w-64">
                ...
                <InputInstrument 
                  type="text" 
                  placeholder="Zoeken..." 
                  className="w-full pl-12 pr-4 py-3 rounded-full bg-va-off-white border border-black/5 text-xs font-bold focus:outline-none focus:border-primary/30 transition-all"
                />
              </ContainerInstrument>
          ...
          <ContainerInstrument className="overflow-x-auto">
            <ContainerInstrument as="table" className="w-full text-left">
              <ContainerInstrument as="thead">
                <ContainerInstrument as="tr" className="border-b border-black/5">
                  <ContainerInstrument as="th" className="pb-6 text-[10px] font-black uppercase tracking-widest text-va-black/30">
                ...
                {participants.map((participant) => (
                  <ContainerInstrument as="tr" key={participant.id} className="group hover:bg-va-off-white/50 transition-all">
                    <ContainerInstrument as="td" className="py-6">
                      <TextInstrument className="font-black uppercase tracking-tight text-sm">
                        {participant.firstName} {participant.lastName}
                      </TextInstrument>
                      <TextInstrument className="text-[10px] font-bold text-va-black/30 uppercase tracking-widest mt-1">
                    ...
                    <ContainerInstrument as="td" className="py-6">
                      <ContainerInstrument className="flex flex-col gap-1">
                        <TextInstrument className="flex items-center gap-2 text-xs font-bold text-va-black/60">
                    ...
                    <ContainerInstrument as="td" className="py-6">
                      <TextInstrument as="span" className={`px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest ${
                    ...
                    <ContainerInstrument as="td" className="py-6 text-xs font-bold text-va-black/40 uppercase tracking-widest">
                    ...
                    <ContainerInstrument as="td" className="py-6 text-right">
                      <ButtonInstrument className="px-4 py-2 rounded-full bg-va-black text-white text-[8px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all shadow-lg">
            ...
            {participants.length === 0 && (
              <ContainerInstrument className="py-20 text-center text-va-black/20 font-black uppercase tracking-widest text-xs">
