    ...
    <PageWrapperInstrument className="min-h-screen bg-va-off-white pt-32 pb-40 px-6 md:px-12">
      <ContainerInstrument className="max-w-7xl mx-auto">
        ...
        <SectionInstrument className="mb-16">
          ...
          <HeadingInstrument level={1} className="text-6xl font-black uppercase tracking-tighter leading-none mb-4">
        ...
        <BentoGrid columns={3}>
          ...
          <BentoCard span="sm" className="bg-white p-10 flex flex-col justify-between border border-black/5 shadow-aura">
            ...
            <Link href="/studio/kalender" className="text-[10px] font-black uppercase tracking-widest text-black/20 hover:text-primary transition-colors flex items-center gap-2">
          ...
          <BentoCard span="sm" className="bg-va-black text-white p-10 flex flex-col justify-between">
            <ContainerInstrument>
              ...
              <ContainerInstrument className="space-y-4">
                ...
                <div className="flex justify-between items-center py-3 border-b border-white/5">
                  ...
                  <span className="text-xs font-black uppercase tracking-tight">63</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-white/5">
                  <span className="text-[10px] font-bold text-white/30 uppercase tracking-widest">
            ...
            <Link href="/account/settings" className="text-[10px] font-black uppercase tracking-widest text-white/20 hover:text-primary transition-colors">
          ...
          <BentoCard span="lg" className="bg-white p-12 border border-black/5 shadow-aura flex flex-col md:flex-row gap-12 items-center">
            <ContainerInstrument className="flex-1">
              <HeadingInstrument level={3} className="text-3xl font-black uppercase tracking-tighter mb-6">
