...
import { Star, CheckCircle, XCircle, ArrowLeft, Loader2, Quote } from 'lucide-react';
      ...
      <BentoGrid columns={4}>
        ...
        <BentoCard span="sm" className="bg-white border border-black/5 p-8 space-y-2">
          ...
          <HeadingInstrument level={3} className="text-4xl font-black tracking-tighter text-green-500">
            <VoiceglotText translationKey="admin.reviews.stats.sentiment_value" defaultText="98% POSITIEF" />
          </HeadingInstrument>
        </BentoCard>
      </BentoGrid>
