    ...
    <PageWrapperInstrument className="min-h-screen bg-va-off-white pt-32 pb-40 px-6">
      <ContainerInstrument className="max-w-5xl mx-auto">
        ...
        <SectionInstrument className="mb-20 text-center space-y-4">
          ...
          <HeadingInstrument level={1} className="text-6xl md:text-7xl font-light tracking-tighter leading-[0.9]"><VoiceglotText  translationKey="studio.interest.title" defaultText="Doe je mee?" /><TextInstrument className="text-va-black/40 font-medium text-xl max-w-2xl mx-auto"><VoiceglotText  
