      ...
      <ContainerInstrument className="max-w-5xl mx-auto">
        ...
        <SectionInstrument className="mb-20 text-center space-y-4">
          <ContainerInstrument className="inline-flex items-center gap-3 px-4 py-2 bg-white/80 backdrop-blur-md rounded-full mb-8 shadow-sm border border-black/[0.03]">
            ...
            <TextInstrument className="text-[15px] font-black tracking-widest text-black/60">
              <VoiceglotText strokeWidth={1.5} translationKey="studio.interest.badge" defaultText="Blijf op de hoogte" / />
            </TextInstrument>
          </ContainerInstrument>
          <HeadingInstrument level={1} className="text-6xl md:text-7xl font-black tracking-tighter leading-[0.9]"><VoiceglotText strokeWidth={1.5} translationKey="studio.interest.title" defaultText="Doe je mee?" / /><TextInstrument className="text-va-black/40 font-medium text-xl max-w-2xl mx-auto"><VoiceglotText strokeWidth={1.5} 
        ...
        {/* FORM */}
        <WorkshopInterestForm strokeWidth={1.5} / />
