        ...
        <ContainerInstrument>
          <ContainerInstrument className="inline-flex items-center gap-3 px-4 py-2 bg-white/80 backdrop-blur-md rounded-[20px] mb-12 shadow-sm border border-black/[0.03]">
            ...
            <TextInstrument className="text-[15px] font-light tracking-widest text-black/60">
              <VoiceglotText strokeWidth={1.5} translationKey="studio.hero.badge" defaultText="Voices Studio • Jouw verhaal komt binnen" / />
            </TextInstrument>
          </ContainerInstrument>
          
          <HeadingInstrument level={1} className="text-[12vw] md:text-[8vw] font-light tracking-tighter leading-[0.8] mb-12 "><VoiceglotText strokeWidth={1.5} translationKey="studio.hero.title_part1" defaultText="Workshops for " / /><br /><TextInstrument className="text-primary font-light"><VoiceglotText strokeWidth={1.5} translationKey="studio.hero.title_part2" defaultText="professionele sprekers." / /></TextInstrument></HeadingInstrument>
          
          <TextInstrument className="text-2xl md:text-3xl text-black/40 font-light leading-tight tracking-tight max-w-3xl"><VoiceglotText strokeWidth={1.5} 
          ...
          <BentoGrid strokeWidth={1.5} columns={3}>
            ...
            <BentoCard span="lg" className="bg-blue-600 p-12 text-white relative overflow-hidden flex flex-col justify-between min-h-[500px] rounded-[20px]">
              <ContainerInstrument className="relative z-10">
                ...
                <HeadingInstrument level={2} className="text-5xl font-light tracking-tighter leading-none mb-8 "><VoiceglotText strokeWidth={1.5} translationKey="studio.bento.guide.title" defaultText="Welke workshop past bij jou?" / /><TextInstrument className="text-white/70 font-light max-w-sm text-[15px] leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="studio.bento.guide.text" defaultText="Geen blabla. Focus op de actie. Ontdek welk traject het beste bij jouw doelen aansluit." / /></TextInstrument></HeadingInstrument>
              </ContainerInstrument>
              <ContainerInstrument className="relative z-10">
                <Link strokeWidth={1.5} href="/studio/quiz">
                  <ButtonInstrument className="va-btn-pro !bg-white !text-black flex items-center gap-4 group !rounded-[10px] font-light tracking-widest "><VoiceglotText strokeWidth={1.5} translationKey="studio.bento.guide.cta" defaultText="Doe de quiz" / /><Image  src="/assets/common/branding/icons/FORWARD.svg" width={18} height={18} alt="" className="group-hover:translate-x-2 transition-transform" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / /></ButtonInstrument>
                </Link>
              </ContainerInstrument>
            ...
            <BentoCard span="sm" className="bg-va-black text-white p-12 flex flex-col justify-between rounded-[20px] shadow-aura-lg">
              <ContainerInstrument>
                ...
                <HeadingInstrument level={3} className="text-3xl font-light tracking-tight mb-6 leading-none">
                  <VoiceglotText strokeWidth={1.5} translationKey="studio.bento.appointment.title" defaultText="Samen aan de slag" / />
                  <TextInstrument className="text-white/40 text-[15px] font-light leading-relaxed">
                    <VoiceglotText strokeWidth={1.5} translationKey="studio.bento.appointment.text" defaultText="Twijfel je over je potentieel? Plan een gesprek in met Johfrah in de studio." / />
                  </TextInstrument>
                </HeadingInstrument>
              </ContainerInstrument>
              <ButtonInstrument as={Link} href="/studio/afspraak" className="w-full py-6 rounded-[10px] bg-white/5 border border-white/10 text-white font-light tracking-widest text-[15px] hover:bg-primary hover:border-primary transition-all duration-500 flex items-center justify-center ">
                <VoiceglotText strokeWidth={1.5} translationKey="studio.bento.appointment.cta" defaultText="Agenda bekijken" / />
              </ButtonInstrument>
            </BentoCard>
            ...
            <BentoCard span="sm" className="bg-white p-12 flex flex-col justify-between rounded-[20px] shadow-aura border border-black/5">
              <ContainerInstrument>
                ...
                <HeadingInstrument level={3} className="text-3xl font-light tracking-tight mb-6 leading-none">
                  <VoiceglotText strokeWidth={1.5} translationKey="studio.bento.academy_bridge.title" defaultText="Academy talent" / />
                  <TextInstrument className="text-va-black/40 text-[15px] font-light leading-relaxed mb-8">
                    <VoiceglotText strokeWidth={1.5} translationKey="studio.bento.academy_bridge.text" defaultText="Er zijn 3 studenten die bijna klaar zijn met hun online traject. Nodig ze uit voor een fysieke sessie." / />
                  </TextInstrument>
                </HeadingInstrument>
              ...
              <ButtonInstrument as={Link} href="/studio/participants" className="text-[15px] font-light tracking-widest text-va-black/20 hover:text-primary transition-colors text-center mt-6">
                <VoiceglotText strokeWidth={1.5} translationKey="studio.bento.academy_bridge.cta" defaultText="Bekijk alle talenten" / />
              </ButtonInstrument>
            </BentoCard>
            ...
            <ContainerInstrument className="md:col-span-2 space-y-12 pt-12">
              <ContainerInstrument className="flex justify-between items-end px-4">
                <HeadingInstrument level={3} className="text-[15px] font-light tracking-widest text-black/30"><VoiceglotText strokeWidth={1.5} translationKey="studio.grid_label" defaultText="Aan de slag in de studio" / /></HeadingInstrument>
                <Link strokeWidth={1.5} href="/studio/kalender" className="text-[15px] font-light tracking-widest text-primary hover:underline flex items-center gap-2"><VoiceglotText strokeWidth={1.5} translationKey="studio.calendar_link" defaultText="Volledige kalender" / /><Image  src="/assets/common/branding/icons/FORWARD.svg" width={12} height={12} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / /></Link>
              </ContainerInstrument>
              {activeWorkshops.length === 0 ? (
                <ContainerInstrument className="p-12 text-center rounded-[20px] border-2 border-dashed border-black/5 bg-va-off-white/30">
                  <TextInstrument className="text-black/40 font-light tracking-tighter"><VoiceglotText strokeWidth={1.5} translationKey="studio.no_workshops" defaultText="Momenteel geen geplande sessies." / /></TextInstrument>
                  <TextInstrument className="text-[15px] text-black/20 font-light mt-2 tracking-widest italic"><VoiceglotText strokeWidth={1.5} translationKey="studio.no_workshops_subtitle" defaultText="Nieuwe data volgen binnenkort." / /></TextInstrument>
                </ContainerInstrument>
              ) : (
                        ...
                        <ContainerInstrument className="relative aspect-video w-full bg-va-black overflow-hidden">
                          ...
                          <ContainerInstrument className="absolute bottom-4 left-6 flex items-center gap-2">
                            ...
                            <TextInstrument className="text-[15px] font-light text-white tracking-widest">
                              <VoiceglotText strokeWidth={1.5} translationKey="studio.aftermovie" defaultText="Aftermovie" / />
                            </TextInstrument>
                          </ContainerInstrument>
                        </ContainerInstrument>
                      )}
                      ...
                      <ContainerInstrument className="p-8 flex flex-col flex-grow">
                        <ContainerInstrument className="flex justify-between items-start mb-8">
                          <ContainerInstrument className="bg-black text-white text-[15px] font-light px-4 py-1.5 rounded-[10px] tracking-widest">
                            <VoiceglotText strokeWidth={1.5} translationKey="studio.workshop_badge" defaultText="Workshop" / />
                          </ContainerInstrument>
                        ...
                        <HeadingInstrument level={3} className="text-2xl font-light tracking-tighter leading-none mb-4 group-hover:text-primary transition-colors">
                          <VoiceglotText strokeWidth={1.5} translationKey={`studio.workshop.${workshop.id}.title`} defaultText={workshop.title} / />
                        </HeadingInstrument>
                        ...
                        <ContainerInstrument className="flex justify-between items-end pt-4 border-t border-black/[0.03]">
                          <ContainerInstrument>
                            <TextInstrument className="text-[15px] text-black/40 font-light tracking-widest mb-1">
                              <VoiceglotText strokeWidth={1.5} translationKey="studio.investment" defaultText="Investering" / />
                            </TextInstrument>
            ...
            <BentoCard span="full" className="bg-white p-16 rounded-[20px] shadow-aura">
              <ContainerInstrument className="max-w-4xl mb-20">
                <HeadingInstrument level={3} className="text-[15px] font-light tracking-widest text-black/30 mb-8"><VoiceglotText strokeWidth={1.5} translationKey="studio.instructors.label" defaultText="Jouw workshopgevers" / /></HeadingInstrument>
                <HeadingInstrument level={2} className="text-6xl font-light tracking-tighter leading-none mb-8"><VoiceglotText strokeWidth={1.5} translationKey="studio.instructors.title_part1" defaultText="Leer professioneler spreken met " / /><br /><TextInstrument className="text-primary font-light"><VoiceglotText strokeWidth={1.5} translationKey="studio.instructors.title_part2" defaultText="Bernadette en Johfrah." / /></TextInstrument></HeadingInstrument>
                <TextInstrument className="text-xl text-black/40 font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="studio.instructors.text" defaultText="Maak kennis met je instructeurs. Wij staan klaar om je te coachen en je spreekvaardigheden naar een hoger niveau te tillen." / /></TextInstrument>
              </ContainerInstrument>
                    ...
                    <ContainerInstrument className="relative aspect-[4/5] rounded-[20px] overflow-hidden shadow-aura-lg grayscale hover:grayscale-0 transition-all duration-1000">
                      ...
                      <ContainerInstrument className="absolute bottom-8 left-8 right-8">
                        <TextInstrument className="text-white/60 text-[15px] font-light tracking-widest mb-2 ">
                          <VoiceglotText strokeWidth={1.5} translationKey={`studio.instructor.${t.id}.tagline`} defaultText={t.tagline || 'Workshopgever'} / />
                        </TextInstrument>
                        <HeadingInstrument level={4} className="text-3xl font-light text-white tracking-tighter leading-none"><VoiceglotText strokeWidth={1.5} translationKey={`studio.instructor.${t.id}.name`} defaultText={t.name} / /></HeadingInstrument>
                      </ContainerInstrument>
                    </ContainerInstrument>
                    <TextInstrument className="text-black/40 text-[15px] font-light leading-relaxed px-4"><VoiceglotText strokeWidth={1.5} translationKey={`studio.instructor.${t.id}.bio`} defaultText={t.bio || ''} / /></TextInstrument>
                  </ContainerInstrument>
                ))}
              </ContainerInstrument>
            </BentoCard>
