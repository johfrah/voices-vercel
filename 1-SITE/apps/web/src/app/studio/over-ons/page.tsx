    ...
    <PageWrapperInstrument className="min-h-screen bg-va-off-white pt-32 pb-40 px-6">
      <ContainerInstrument className="max-w-5xl mx-auto">
        ...
        <SectionInstrument className="mb-20 space-y-4">
          ...
          <HeadingInstrument level={1} className="text-6xl font-black tracking-tighter leading-none"><VoiceglotText translationKey="studio.about.title" defaultText="Vakmanschap achter" /><br /><TextInstrument className="text-primary font-light"><VoiceglotText translationKey="auto.page.het_geluid_.567d64" defaultText="het geluid." /></TextInstrument></HeadingInstrument>
