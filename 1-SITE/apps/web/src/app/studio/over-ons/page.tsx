    ...
    <PageWrapperInstrument className="min-h-screen bg-va-off-white pt-32 pb-40 px-6">
      <ContainerInstrument className="max-w-5xl mx-auto">
        ...
        <SectionInstrument className="mb-20 space-y-4">
          ...
          <HeadingInstrument level={1} className="text-6xl font-black tracking-tighter leading-none"><VoiceglotText strokeWidth={1.5} translationKey="studio.about.title" defaultText="Vakmanschap achter" / /><br /><TextInstrument className="text-primary font-light"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.het_geluid_.567d64" defaultText="het geluid." / /></TextInstrument></HeadingInstrument>
        ...
        <ContainerInstrument className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
          ...
          <ContainerInstrument className="space-y-8">
            <ContainerInstrument className="space-y-4">
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tighter text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="studio.about.founder.title" defaultText="Johfrah Lefebvre" / /><TextInstrument className="text-va-black/60 font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} 
              ...
              <TextInstrument className="text-va-black/60 font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} 
            ...
            <ContainerInstrument className="flex items-center gap-4">
              ...
              <TextInstrument className="text-[15px] font-light tracking-widest text-va-black/40"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.international_emmy_a.39163c" defaultText="International Emmy Award winner" / /></TextInstrument>
            </ContainerInstrument>
          </ContainerInstrument>
        </ContainerInstrument>
        ...
        <ContainerInstrument className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
          <ContainerInstrument className="order-2 md:order-1 space-y-8">
            <ContainerInstrument className="space-y-4">
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tighter text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="studio.about.coach.title" defaultText="Bernadette Timmermans" / /><TextInstrument className="text-va-black/60 font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} 
            ...
            <ContainerInstrument className="flex items-center gap-4">
              <Image  src="/assets/common/branding/icons/INFO.svg" width={32} height={32} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
              <TextInstrument className="text-[15px] font-light tracking-widest text-va-black/40"><VoiceglotText strokeWidth={1.5} translationKey="studio.about.coach.badge" defaultText="VRT stemcoach & expert" / /></TextInstrument>
            </ContainerInstrument>
          </ContainerInstrument>
        ...
        <ContainerInstrument className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          <ContainerInstrument className="p-10 rounded-[20px] bg-white border border-black/5 shadow-aura space-y-6">
            <Image  src="/assets/common/branding/icons/INFO.svg" width={32} height={32} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
            <HeadingInstrument level={3} className="text-xl font-light tracking-tight text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.top_selectie.e9e6c4" defaultText="Top-selectie" / /><TextInstrument className="text-va-black/40 text-[15px] font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.geen_eindeloze_lijst.b1c678" defaultText="Geen eindeloze lijsten, maar een gecureerde groep stemmen die we persoonlijk kennen en regisseren." / /></TextInstrument></HeadingInstrument>
          </ContainerInstrument>
          <ContainerInstrument className="p-10 rounded-[20px] bg-white border border-black/5 shadow-aura space-y-6">
            <Image  src="/assets/common/branding/icons/INFO.svg" width={32} height={32} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
            <HeadingInstrument level={3} className="text-xl font-light tracking-tight text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.technische_perfectie.ea0d36" defaultText="Technische perfectie" / /><TextInstrument className="text-va-black/40 text-[15px] font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.alles_wordt_geleverd.dd6681" defaultText="Alles wordt geleverd in 48kHz studiokwaliteit, genormaliseerd volgens de strengste loudness-normen." / /></TextInstrument></HeadingInstrument>
          </ContainerInstrument>
          <ContainerInstrument className="p-10 rounded-[20px] bg-va-black text-white space-y-6">
            ...
            <HeadingInstrument level={3} className="text-xl font-light tracking-tight text-white"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.digitale_kluis.571296" defaultText="Digitale kluis" / /><TextInstrument className="text-white/40 text-[15px] font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.we_bewaren_al_je_scr.a10adf" defaultText="We bewaren al je scripts en instellingen. Een pickup over een jaar klinkt daardoor exact zoals vandaag." / /></TextInstrument></HeadingInstrument>
          </ContainerInstrument>
        </ContainerInstrument>
