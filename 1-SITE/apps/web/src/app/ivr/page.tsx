      ...
      <SectionInstrument className="max-w-7xl mx-auto px-6 pt-20">
        <ContainerInstrument className="mb-16 space-y-4">
          ...
          <HeadingInstrument level={1} className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.85]">
            ...
            <TextInstrument as="span" className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/80">
        ...
        <BentoGrid>
          <BentoCard span="lg" className="bg-va-black text-white p-12 flex flex-col justify-between group">
            ...
            <Link href="/johfrai" className="flex items-center gap-2 text-primary font-black uppercase tracking-widest text-[10px] mt-8 group-hover:gap-4 transition-all">
          ...
          <BentoCard span="sm" className="bg-white shadow-aura p-12 flex flex-col justify-between group">
            ...
            <Link href="/agency" className="flex items-center gap-2 text-blue-500 font-black uppercase tracking-widest text-[10px] mt-8 group-hover:gap-4 transition-all">
          ...
          <BentoCard span="sm" className="hred text-white p-12 flex flex-col justify-between group">
            ...
            <Link href="/agency/music" className="flex items-center gap-2 text-white font-black uppercase tracking-widest text-[10px] mt-8 group-hover:gap-4 transition-all">
