        ...
        <ContainerInstrument key={order.id} className="flex items-center justify-between p-4 bg-white/50 rounded-xl border border-black/5">
          <ContainerInstrument className="flex items-center gap-4">
            ...
            <ContainerInstrument>
              ...
              <TextInstrument className="text-[10px] text-black/40 uppercase font-black">{order.user?.firstName} {order.user?.lastName}</TextInstrument>
            </ContainerInstrument>
          </ContainerInstrument>
          <ContainerInstrument className="text-right">
            <TextInstrument className="text-sm font-black">€ {order.total}</TextInstrument>
            <TextInstrument className="text-[10px] text-black/40 uppercase font-bold">{new Date(order.createdAt!).toLocaleDateString()}</TextInstrument>
          </ContainerInstrument>
        </ContainerInstrument>
      ))}
    </ContainerInstrument>
      ...
      <ContainerInstrument className="max-w-7xl mx-auto">
        <SectionInstrument className="mb-12">
          ...
          <HeadingInstrument level={1} className="text-5xl font-black tracking-tighter leading-none mb-4">
            ...
            <TextInstrument as="span" className="text-va-primary">
        ...
        <ContainerInstrument className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
          ...
          <ContainerInstrument className="bg-white rounded-[40px] p-8 border border-black/[0.03] shadow-sm">
            <ContainerInstrument className="flex justify-between items-start mb-6">
              ...
              <TextInstrument as="span" className="text-[10px] font-black text-black/20 uppercase tracking-widest">
            ...
            <TextInstrument className="text-[10px] text-black/40 uppercase font-bold tracking-widest">
            ...
            <ContainerInstrument className="mt-6 pt-6 border-t border-black/5 flex justify-between">
              <ContainerInstrument>
                ...
                <TextInstrument className="text-[9px] text-black/40 uppercase font-bold">
        ...
        <ContainerInstrument className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <ContainerInstrument className="bg-white rounded-[40px] p-8 border border-black/[0.03] shadow-sm">
            <HeadingInstrument level={2} className="text-xl font-black tracking-tighter mb-8 uppercase italic">
          ...
          <ContainerInstrument className="bg-black text-white rounded-[40px] p-8 border border-black/[0.03] shadow-lg overflow-hidden relative">
            <ContainerInstrument className="relative z-10">
              <HeadingInstrument level={2} className="text-xl font-black tracking-tighter mb-4 uppercase italic">
                <VoiceglotText translationKey="admin.dashboard.ai_title" defaultText="Intelligence" />
              </HeadingInstrument>
              <TextInstrument className="text-white/60 text-sm mb-8">
              ...
              <ContainerInstrument className="space-y-6">
                <ContainerInstrument className="p-4 bg-white/10 rounded-xl border border-white/10">
                  <TextInstrument className="text-[10px] font-black text-va-primary uppercase mb-1">
                    <VoiceglotText translationKey="admin.dashboard.insight_label_1" defaultText="Inzicht #1" />
                  </TextInstrument>
                  <TextInstrument className="text-sm">
                    <VoiceglotText 
