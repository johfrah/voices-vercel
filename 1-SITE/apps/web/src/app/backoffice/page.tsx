  ...
  return (
    <ContainerInstrument className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-8">
      ...
      <ContainerInstrument className="bg-white rounded-[40px] p-6 hmagic text-white border-none">
        <TextInstrument className="text-[15px] font-light text-white/50 tracking-widest mb-2"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.revenue_label" defaultText="Omzet" / /></TextInstrument>
        <HeadingInstrument level={2} className="text-4xl font-light tracking-tighter">{totalRevenue}</HeadingInstrument>
        <ContainerInstrument className="mt-4 text-[15px] font-light bg-white/20 inline-block px-2 py-1 rounded"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.profit_engine" defaultText="Dashboard" / /></ContainerInstrument>
      </ContainerInstrument>

      {/* Orders Card */}
      <ContainerInstrument className="bg-white rounded-[40px] p-6 border border-black/[0.03] shadow-sm">
        <TextInstrument className="text-[15px] font-light text-va-black/30 tracking-widest mb-2"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.orders_label" defaultText="Bestellingen" / /></TextInstrument>
      ...
      {/* Users Card */}
      <ContainerInstrument className="bg-white rounded-[40px] p-6 border border-black/[0.03] shadow-sm">
        <TextInstrument className="text-[15px] font-light text-va-black/30 tracking-widest mb-2"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.users_label" defaultText="Gebruikers" / /></TextInstrument>
        <HeadingInstrument level={2} className="text-4xl font-light tracking-tighter">{userCount.value}</HeadingInstrument>
        <TextInstrument className="text-[15px] text-va-black/40 font-light mt-2"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.users_subtitle" defaultText="Geverifieerd" / /></TextInstrument>
      </ContainerInstrument>

      {/* Actors Card */}
      <ContainerInstrument className="bg-white rounded-[40px] p-6 border border-black/[0.03] shadow-sm">
        <TextInstrument className="text-[15px] font-light text-va-black/30 tracking-widest mb-2"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.voices_label" defaultText="Stemmen" / /></TextInstrument>
        <HeadingInstrument level={2} className="text-4xl font-light tracking-tighter">{actorCount.value}</HeadingInstrument>
        <TextInstrument className="text-[15px] text-va-black/40 font-light mt-2"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.voices_subtitle" defaultText="Totaal" / /></TextInstrument>
      </ContainerInstrument>
    </ContainerInstrument>
  );
}
...
async function RecentActivity() {
  ...
  return (
    <ContainerInstrument className="bg-white rounded-[40px] m-8 p-8 border border-black/[0.03] shadow-sm">
      <HeadingInstrument level={3} className="text-xl font-light tracking-tighter mb-6 "><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.recent_activity" defaultText="Activiteit" / /></HeadingInstrument>
  ...
  return (
    <PageWrapperInstrument className="min-h-screen bg-va-off-white pt-24">
      <SectionInstrument className="px-8 mb-8">
        <HeadingInstrument level={1} className="text-4xl font-light tracking-tighter "><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.title" defaultText="Backoffice" / /><TextInstrument className="text-va-black/40 font-light text-[15px] tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.subtitle" defaultText="Voices" / /></TextInstrument></HeadingInstrument>
      </SectionInstrument>

      <Suspense strokeWidth={1.5} fallback={<LoadingScreenInstrument / />}>
        <StatsGrid strokeWidth={1.5} / />
        <ContainerInstrument className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <ContainerInstrument className="grid grid-cols-1 md:grid-cols-2 gap-4 m-8">
            ...
            <ButtonInstrument as="a" href="/backoffice/media" className="bg-white rounded-[40px] p-8 border border-black/[0.03] shadow-sm flex flex-col justify-between hover:scale-[1.02] transition-all group">
              ...
              <ContainerInstrument>
                <HeadingInstrument level={4} className="font-light tracking-tighter text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.media_library" defaultText="Media" / /><TextInstrument className="text-[15px] font-light text-va-black/30 tracking-widest mt-1"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.media_library_subtitle" defaultText="Beheer online assets" / /></TextInstrument></HeadingInstrument>
              </ContainerInstrument>
            </ButtonInstrument>
            ...
            <ContainerInstrument className="bg-transparent rounded-[40px] p-8 flex flex-col items-center justify-center text-center border-dashed border-2 border-black/10 shadow-none">
              ...
              <HeadingInstrument level={4} className="font-light tracking-tighter text-va-black/40 text-[15px]"><VoiceglotText strokeWidth={1.5} translationKey="admin.cockpit.lead_scoring" defaultText="Leads" / /><TextInstrument className="text-[15px] font-light text-va-black/20 tracking-widest mt-2"><VoiceglotText strokeWidth={1.5} translationKey="common.coming_soon" defaultText="Binnenkort" / /></TextInstrument></HeadingInstrument>
            </ContainerInstrument>
          </ContainerInstrument>
        </ContainerInstrument>
      </Suspense>
