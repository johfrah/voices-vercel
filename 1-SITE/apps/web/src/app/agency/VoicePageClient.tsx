        ...
        <ContainerInstrument className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <ContainerInstrument className="flex gap-4">
            <ContainerInstrument className="relative">
              ...
              <InputInstrument 
                type="text" 
                placeholder={t('agency.search.placeholder', 'Zoek op naam of taal...')}
                className="bg-white border border-black/5 rounded-2xl pl-12 pr-6 py-4 text-sm font-medium focus:ring-2 focus:ring-primary/20 transition-all w-64 shadow-sm"
                value={search}
