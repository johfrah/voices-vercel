        ...
        <ContainerInstrument className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <ContainerInstrument className="space-y-4">
            <ContainerInstrument className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-primary text-[15px] font-light tracking-widest border border-primary/20">
              ...
              <VoiceglotText strokeWidth={1.5} translationKey="agency.client.badge" defaultText="Voice Casting" / />
            </ContainerInstrument>
            <HeadingInstrument level={1} className="text-6xl md:text-8xl font-light tracking-tighter leading-none">
              <VoiceglotText strokeWidth={1.5} translationKey="agency.client.title_part1" defaultText="Vind jouw " / />
              <TextInstrument as="span" className="text-primary font-light">
                <VoiceglotText strokeWidth={1.5} translationKey="agency.client.title_part2" defaultText="Stem" / />
              </TextInstrument>
            </HeadingInstrument>
          </ContainerInstrument>
              ...
              <ContainerInstrument className="p-6">
                <ContainerInstrument className="flex justify-between items-start mb-1">
                  <HeadingInstrument level={3} className="font-light tracking-tight text-lg">
                    <VoiceglotText strokeWidth={1.5} translationKey={`actor.${actor.id}.name`} defaultText={actor.display_name} noTranslate={true} / />
                  </HeadingInstrument>
                ...
                <TextInstrument className="text-[15px] font-light tracking-widest text-va-black/30">
                  <VoiceglotText strokeWidth={1.5} translationKey={`common.language.${actor.native_lang?.toLowerCase()}`} defaultText={actor.native_lang || ''} / />
                  <VoiceglotText strokeWidth={1.5} translationKey="common.native" defaultText="Native" / />
                </TextInstrument>
              </ContainerInstrument>
            </Link>
          </BentoCard>
