    ...
    <PageWrapperInstrument className="relative min-h-screen pt-32 pb-20 overflow-hidden">
      ...
      <SectionInstrument className="max-w-5xl mx-auto px-6 relative z-10">
        <ContainerInstrument className="mb-16">
          ...
          <HeadingInstrument level={1} className="text-6xl font-black tracking-tighter leading-none mb-6"><VoiceglotText translationKey="story.skygge.title" defaultText="SKYGGE | Professionalisering via audio" /><TextInstrument className="text-xl text-va-black/40 font-medium max-w-2xl"><VoiceglotText 
        ...
        <BentoGrid columns={2}>
          ...
          >
            <HeadingInstrument level={3} className="text-2xl font-black tracking-tight mb-6"><VoiceglotText translationKey="story.skygge.challenge.title" defaultText="De Uitdaging" /><TextInstrument className="text-white/60 leading-relaxed font-light"><VoiceglotText 
          ...
          >
            <HeadingInstrument level={3} className="text-2xl font-black tracking-tight mb-6"><VoiceglotText translationKey="story.skygge.solution.title" defaultText="De Oplossing" /><TextInstrument className="text-va-black/60 leading-relaxed font-light"><VoiceglotText 
