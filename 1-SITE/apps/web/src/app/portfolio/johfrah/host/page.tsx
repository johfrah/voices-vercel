        ...
        <ContainerInstrument className="max-w-7xl mx-auto px-6">
          <ContainerInstrument className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            <ContainerInstrument className="space-y-8">
              ...
              <HeadingInstrument level={1} className="text-6xl md:text-8xl font-light leading-[0.9] tracking-tighter">
          ...
          {/* Video Showcase */}
          <HeadingInstrument level={2} className="text-4xl font-light tracking-tighter mb-12 text-center"><VoiceglotText  translationKey="auto.page.in_actie.b5aa14" defaultText="In Actie" /></HeadingInstrument>
