          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 space-y-10">
              ...
              <HeadingInstrument level={1} className="text-6xl md:text-8xl font-extralight leading-[0.9] tracking-tighter text-va-black">
                Johfrah <br />
                <span className="text-primary/40"><VoiceglotText translationKey="auto.page.lefebvre.6eaa14" defaultText="Lefebvre" /></span>
              </HeadingInstrument>
              ...
              <ContainerInstrument className="max-w-lg text-[15px] text-va-black/60 leading-relaxed font-light"><VoiceglotText translationKey="portfolio.johfrah.bio" defaultText={data.extended_bio} /></ContainerInstrument>

              <div className="flex flex-wrap items-center gap-8 pt-4">
                <ButtonInstrument as="a" href="#demos" className="va-btn-pro !rounded-[10px] px-10 py-5"><VoiceglotText translationKey="portfolio.johfrah.cta.demos" defaultText="Beluister Demo's" /></ButtonInstrument>
            ...
            <div className="lg:col-span-5 relative group">
              ...
              {/* <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-[20px] shadow-aura flex items-center gap-4 max-w-[200px] animate-float border border-black/[0.03]">
                ...
                <TextInstrument className="text-[15px] font-black leading-tight tracking-wider text-va-black/60"><VoiceglotText translationKey="auto.page.emmy_award_winnaar.af6af1" defaultText="Emmy Award Winnaar" /></TextInstrument>
              </div> */}
            </div>
          </div>
        </ContainerInstrument>
        ...
        <BentoGrid columns={3}>
          <HostCardLink span="lg" className="hblue text-white p-12 relative overflow-hidden group cursor-pointer rounded-[20px] shadow-aura-lg min-h-[500px] flex flex-col justify-between border border-white/10">
            ...
            <div className="relative z-10">
              <TextInstrument className="text-[15px] font-light text-white/50 leading-relaxed mb-8 border-l-2 border-white/10 pl-6"><VoiceglotText translationKey="portfolio.johfrah.host.experience" defaultText={data.host_content.experience} /></TextInstrument>
              <ButtonInstrument className="va-btn-pro !bg-white !text-va-black !rounded-[10px] px-8"><VoiceglotText translationKey="auto.page.bekijk_host_werk.55f433" defaultText="Bekijk Host Werk" /></ButtonInstrument>
            </div>
          ...
          <BentoCard id="demos" span="full" className="bg-white p-16 rounded-[20px] shadow-aura border border-black/[0.02]">
            <div className="max-w-2xl mb-16">
              <HeadingInstrument level={2} className="text-5xl md:text-6xl font-light tracking-tighter leading-none mb-8 text-va-black">
                De <span className="text-primary/60 italic">stem</span> <br /><VoiceglotText translationKey="auto.page.die_jouw_verhaal_dra.2fec19" defaultText="die jouw verhaal draagt." /></HeadingInstrument>
              <TextInstrument className="text-[15px] text-va-black/40 font-light leading-relaxed"><VoiceglotText translationKey="auto.page.luister_naar_mijn_we.bb04a7" defaultText="Luister naar mijn werk. Van intieme verhalen tot krachtige commercials. Altijd met de juiste nuance." /></TextInstrument>
            </div>
      ...
      <SectionInstrument id="contact" className="py-32 bg-white relative overflow-hidden border-t border-black/[0.03]">
        ...
        <ContainerInstrument className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <HeadingInstrument level={2} className="text-5xl md:text-7xl font-extralight text-va-black tracking-tighter leading-none mb-12">
            Klaar voor <br />
            <span className="text-primary/60 italic"><VoiceglotText translationKey="auto.page.jouw_verhaal_.c8adec" defaultText="jouw verhaal?" /></span>
          </HeadingInstrument>
          <div className="flex flex-col md:flex-row items-center justify-center gap-10">
            <a href="mailto:hallo@johfrah.be">
              <ButtonInstrument className="va-btn-pro !rounded-[10px] px-16 py-6 text-lg shadow-aura-lg hover:scale-105 transition-transform"><VoiceglotText translationKey="auto.page.start_een_project.0e6a12" defaultText="Start een project" /></ButtonInstrument></a>
            <a href="tel:+32475123456" className="text-va-black/30 hover:text-primary transition-colors font-light tracking-[0.2em] text-[15px] "><VoiceglotText translationKey="auto.page.bel_direct___32_475_.628911" defaultText="BEL DIRECT: +32 475 12 34 56" /></a>
          </div>
        </ContainerInstrument>
      </SectionInstrument>
