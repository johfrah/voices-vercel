        ...
        <div className="bg-white shadow-aura rounded-[40px] p-12 space-y-12">
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-primary mb-4">
              <Shield size={20} />
              <HeadingInstrument level={2} className="text-xl font-black uppercase tracking-tight">Functionele Cookies</HeadingInstrument>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-primary mb-4">
              <Eye size={20} />
              <HeadingInstrument level={2} className="text-xl font-black uppercase tracking-tight">Analytische Cookies</HeadingInstrument>
            </div>
            <TextInstrument className="text-va-black/60 leading-relaxed">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-primary mb-4">
              <Settings size={20} />
              <HeadingInstrument level={2} className="text-xl font-black uppercase tracking-tight">Jouw Voorkeuren</HeadingInstrument>
            </div>
            <TextInstrument className="text-va-black/60 leading-relaxed">
