    ...
    <PageWrapperInstrument className="relative min-h-screen pt-32 pb-20 overflow-hidden">
      ...
      <SectionInstrument className="max-w-6xl mx-auto px-6 relative z-10">
        <ContainerInstrument className="mb-16">
          ...
          <HeadingInstrument level={1} className="text-6xl font-light tracking-tighter leading-none mb-6"><VoiceglotText  translationKey="music.title" defaultText="Wachtmuziek die werkt" /><TextInstrument className="text-xl text-va-black/40 font-medium max-w-2xl"><VoiceglotText  
        ...
        <BentoGrid strokeWidth={1.5} columns={3}>
          ...
          >
            ...
            <ContainerInstrument className="space-y-6">
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tight"><VoiceglotText  translationKey="music.psychology.title" defaultText="De psychologie van het wachten" /><TextInstrument className="text-white/80 text-lg leading-relaxed font-light"><VoiceglotText  
          ...
          >
            ...
            <HeadingInstrument level={3} className="text-2xl font-light tracking-tight mb-4"><VoiceglotText  translationKey="music.quality.title" defaultText="Geoptimaliseerd" /><TextInstrument className="text-va-black/60 leading-relaxed font-light"><VoiceglotText  
          ...
          >
            ...
            <HeadingInstrument level={3} className="text-2xl font-light tracking-tight mb-4"><VoiceglotText  translationKey="music.rights.title" defaultText="Rechtenvrij" /><TextInstrument className="text-white/60 leading-relaxed font-light"><VoiceglotText  
