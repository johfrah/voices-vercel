      ...
      <SectionInstrument className="max-w-7xl mx-auto px-6 relative z-10">
        <ContainerInstrument className="text-center mb-20 space-y-6">
          ...
          <HeadingInstrument level={1} className="text-6xl md:text-8xl font-light tracking-tighter leading-none">
            <VoiceglotText strokeWidth={1.5} translationKey="about.title_part1" defaultText="Het Vriendelijkste " / />
            <TextInstrument as="span" className="text-primary font-extralight">
              <VoiceglotText strokeWidth={1.5} translationKey="about.title_part2" defaultText="Stemmenbureau" / />
            </TextInstrument>
          </HeadingInstrument>
        ...
        <BentoGrid strokeWidth={1.5} columns={3}>
          ...
          >
            <ContainerInstrument className="space-y-6">
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tight">
                <VoiceglotText strokeWidth={1.5} translationKey="about.mission.title" defaultText="Een stem die echt is en vertrouwen geeft." / />
          ...
          >
            <ContainerInstrument className="space-y-4">
              <ContainerInstrument className="flex items-center gap-3">
                ...
                <TextInstrument className="text-[15px] font-light tracking-widest "><VoiceglotText strokeWidth={1.5} translationKey="about.value1" defaultText="Snelheid" / /></TextInstrument>
              </ContainerInstrument>
              <ContainerInstrument className="flex items-center gap-3">
                <ShieldCheck strokeWidth={1.5} size={16} className="text-primary" />
                <TextInstrument className="text-[15px] font-light tracking-widest "><VoiceglotText strokeWidth={1.5} translationKey="about.value2" defaultText="Kwaliteit" / /></TextInstrument>
              </ContainerInstrument>
              <ContainerInstrument className="flex items-center gap-3">
                <Heart strokeWidth={1.5} size={16} className="text-primary" />
                <TextInstrument className="text-[15px] font-light tracking-widest "><VoiceglotText strokeWidth={1.5} translationKey="about.value3" defaultText="Vriendelijkheid" / /></TextInstrument>
              </ContainerInstrument>
            </ContainerInstrument>
          </BentoCard>
          ...
          >
            <ContainerInstrument className="space-y-4 max-w-xl">
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tight">
                <VoiceglotText strokeWidth={1.5} translationKey="about.cta.title" defaultText="Vind de stem die bij je past" / />
            ...
            <ContainerInstrument className="va-btn-pro !bg-white !text-va-black px-10 py-5 !rounded-[10px] font-light tracking-widest "><VoiceglotText strokeWidth={1.5} translationKey="about.cta.button" defaultText="Ontdek de Stemmen" / /></ContainerInstrument>
          </BentoCard>
        </BentoGrid>
      </SectionInstrument>
