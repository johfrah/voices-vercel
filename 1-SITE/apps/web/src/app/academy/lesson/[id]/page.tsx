      ...
      <PageWrapperInstrument className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        ...
        <SectionInstrument className="mb-12 space-y-6">
          ...
          <ContainerInstrument className="space-y-2">
            <HeadingInstrument level={1} className="text-5xl font-light tracking-tighter"><VoiceglotText  translationKey={`academy.lesson.${params.id}.title`} defaultText={data.header.title} /></HeadingInstrument>
          </ContainerInstrument>
        </SectionInstrument>
      ...
      <BentoGrid>
        ...
        <ContainerInstrument className="space-y-8">
          ...
          <BentoCard span="sm" className="hred text-white">
            <HeadingInstrument level={4} className="text-[15px] font-light tracking-widest text-white/40 mb-6 flex items-center gap-2">
