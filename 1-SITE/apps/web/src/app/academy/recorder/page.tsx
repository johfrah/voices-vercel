  ...
  return (
    <PageWrapperInstrument className="max-w-7xl mx-auto px-6 py-20">
      <SectionInstrument className="mb-16 space-y-4">
        <ContainerInstrument className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-[15px] font-black tracking-widest text-primary border border-primary/20">
      ...
      <BentoGrid>
        ...
        <ContainerInstrument className="md:col-span-2">
          <BentoCard span="full" className="bg-va-black text-white p-12 shadow-aura min-h-[400px] flex flex-col justify-between">
            <ContainerInstrument className="space-y-8">
              <HeadingInstrument level={3} className="text-[15px] font-black tracking-widest text-white/20">
            ...
            <ContainerInstrument className="flex items-center gap-4 pt-12 border-t border-white/5">
              ...
              <TextInstrument as="span" className="text-[15px] font-black tracking-widest text-white/40">
        ...
        <ContainerInstrument className="space-y-8">
          <BentoCard span="sm" className="bg-white p-8 shadow-aura border-black/5 flex flex-col items-center justify-center text-center">
            ...
            <HeadingInstrument level={4} className="text-xl font-black tracking-tight mb-2">
              <VoiceglotText translationKey="academy.recorder.start_opname" defaultText="Start Opname" />
            </HeadingInstrument>
            <TextInstrument className="text-va-black/40 text-[15px] font-medium mb-8">
            ...
            <ContainerInstrument className="flex gap-4 w-full">
              <ButtonInstrument className="flex-1 py-4 rounded-xl bg-va-black text-white text-[15px] font-black tracking-widest hover:bg-primary transition-all">
                <VoiceglotText translationKey="common.stop" defaultText="Stop" />
              </ButtonInstrument>
              <ButtonInstrument className="flex-1 py-4 rounded-xl bg-va-off-white text-va-black text-[15px] font-black tracking-widest hover:bg-black/5 transition-all">
