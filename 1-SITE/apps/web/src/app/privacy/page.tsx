    ...
    <PageWrapperInstrument className="pt-32 pb-40 px-6 md:px-12 bg-va-off-white min-h-screen">
      <ContainerInstrument className="max-w-4xl mx-auto">
        ...
        <SectionInstrument className="mb-16">
          ...
          <HeadingInstrument level={1} className="text-6xl font-light tracking-tighter leading-none mb-6"><VoiceglotText  translationKey="privacy.title" defaultText="Jouw Privacy." /><TextInstrument className="text-va-black/40 font-medium text-xl"><VoiceglotText  
        ...
        <ContainerInstrument className="bg-white shadow-aura rounded-[40px] p-12 space-y-12">
          <section className="space-y-4">
            <ContainerInstrument className="flex items-center gap-3 text-primary mb-4">
              ...
              <HeadingInstrument level={2} className="text-xl font-light tracking-tight"><VoiceglotText  translationKey="auto.page.welke_gegevens_verza.3f2ccd" defaultText="Welke gegevens verzamelen we?" /></HeadingInstrument>
            </ContainerInstrument>
          ...
          <section className="space-y-4">
            <ContainerInstrument className="flex items-center gap-3 text-primary mb-4">
              ...
              <HeadingInstrument level={2} className="text-xl font-light tracking-tight"><VoiceglotText  translationKey="auto.page.hoe_beschermen_we_je.c13679" defaultText="Hoe beschermen we je data?" /></HeadingInstrument>
            </ContainerInstrument>
          ...
          <section className="space-y-4">
            <ContainerInstrument className="flex items-center gap-3 text-primary mb-4">
              ...
              <HeadingInstrument level={2} className="text-xl font-light tracking-tight"><VoiceglotText  translationKey="auto.page.jouw_rechten.73346d" defaultText="Jouw Rechten" /></HeadingInstrument>
            </ContainerInstrument>
