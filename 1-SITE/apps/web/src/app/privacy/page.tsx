      ...
      <ContainerInstrument className="max-w-4xl mx-auto">
        ...
        <SectionInstrument className="mb-16">
          <ContainerInstrument className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-primary text-[15px] font-black tracking-widest border border-primary/10 mb-8">
            ...
            <VoiceglotText strokeWidth={1.5} translationKey="privacy.badge" defaultText="Privacy & Veiligheid" / />
          </ContainerInstrument>
          <HeadingInstrument level={1} className="text-6xl font-black tracking-tighter leading-none mb-6"><VoiceglotText strokeWidth={1.5} translationKey="privacy.title" defaultText="Jouw Privacy." / /><TextInstrument className="text-va-black/40 font-medium text-xl"><VoiceglotText strokeWidth={1.5} 
