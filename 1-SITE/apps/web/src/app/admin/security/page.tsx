    ...
    <PageWrapperInstrument className="p-12 space-y-12 max-w-[1600px] mx-auto min-h-screen">
      ...
      <SectionInstrument className="flex justify-between items-end">
        <ContainerInstrument className="space-y-4">
          ...
          <HeadingInstrument level={1} className="text-6xl font-black tracking-tighter ">
            Nuclear <TextInstrument className="text-primary font-light"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.security.2fae32" defaultText="Security" / /></TextInstrument>
          </HeadingInstrument>
        </ContainerInstrument>
      </SectionInstrument>
        ...
        <BentoCard span="lg" className="bg-white border border-black/5 p-10 space-y-8">
          <ContainerInstrument className="flex justify-between items-start">
            <ContainerInstrument className="space-y-2">
              <HeadingInstrument level={3} className="text-3xl font-black tracking-tight"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.multi_factor_auth.c21bd5" defaultText="Multi-Factor Auth" / /><TextInstrument className="text-va-black/40 font-medium max-w-md"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.beveilig_de_toegang_.044ee4" defaultText="Beveilig de toegang tot je mailbox en de database met een extra code via je telefoon." / /></TextInstrument></HeadingInstrument>
            </ContainerInstrument>
          ...
          <ContainerInstrument className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            <ContainerInstrument className="p-6 bg-va-off-white rounded-[32px] space-y-4 border border-black/5">
              ...
              <HeadingInstrument level={4} className="text-[15px] font-black tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.authenticator_app.5c5737" defaultText="Authenticator App" / /><TextInstrument className="text-[15px] font-medium text-va-black/40 leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.gebruik_google_authe.93d11f" defaultText="Gebruik Google Authenticator, Authy of iCloud Keychain voor tijdgebonden codes." / /></TextInstrument></HeadingInstrument>
              <ButtonInstrument 
            ...
            <ContainerInstrument className="p-6 bg-va-off-white rounded-[32px] space-y-4 border border-black/5 opacity-40">
              ...
              <HeadingInstrument level={4} className="text-[15px] font-black tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.biometrische_lock.1c69d0" defaultText="Biometrische Lock" / /><TextInstrument className="text-[15px] font-medium text-va-black/40 leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.gebruik_faceid_of_to.667b20" defaultText="Gebruik FaceID of TouchID om direct in te loggen zonder wachtwoord." / /></TextInstrument></HeadingInstrument>
              <ContainerInstrument className="text-[15px] font-black tracking-widest text-va-black/20"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.binnenkort_beschikba.b9656f" defaultText="Binnenkort Beschikbaar" / /></ContainerInstrument>
            </ContainerInstrument>
          </ContainerInstrument>
        </BentoCard>
        ...
        <BentoCard span="sm" className="bg-va-black text-white p-10 space-y-8 flex flex-col justify-between">
          <ContainerInstrument className="space-y-4">
            ...
            <HeadingInstrument level={3} className="text-2xl font-black tracking-tighter leading-tight">
              Admin<br /><VoiceglotText strokeWidth={1.5} translationKey="auto.page.escalation.a5a3f5" defaultText="Escalation" / /></HeadingInstrument>
            <TextInstrument className="text-[15px] font-medium opacity-60"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.dwing_een_extra_2fa_.72133d" defaultText="Dwing een extra 2FA check af voor gevoelige acties:" / /></TextInstrument>
          ...
          <ContainerInstrument className="pt-6 border-t border-white/10">
            <ContainerInstrument className="flex items-center justify-between">
              <TextInstrument className="text-[15px] font-black tracking-widest opacity-40"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.status.ec53a8" defaultText="Status" / /></TextInstrument>
              <TextInstrument className="text-[15px] font-black tracking-widest text-primary"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.strict_mode.0711dd" defaultText="Strict Mode" / /></TextInstrument>
            </ContainerInstrument>
          </ContainerInstrument>
        </BentoCard>
      </BentoGrid>
      ...
      <BentoCard span="full" className="bg-white border border-black/5 p-10 space-y-6">
        <ContainerInstrument className="flex justify-between items-center">
          <HeadingInstrument level={3} className="text-xl font-black tracking-tight flex items-center gap-3">
            <History strokeWidth={1.5} size={20} className="text-va-black/20" / /><VoiceglotText strokeWidth={1.5} translationKey="auto.page.security_audit_log.c86e03" defaultText="Security Audit Log" / /></HeadingInstrument>
          <ButtonInstrument className="text-[15px] font-black tracking-widest text-va-black/20 hover:text-va-black transition-colors"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.download_volledig_lo.b47b76" defaultText="Download Volledig Log" / /></ButtonInstrument>
        </ContainerInstrument>
        <ContainerInstrument className="space-y-2">
          {[
      ...
      <ContainerInstrument className="p-8 bg-va-black text-white rounded-[32px] flex items-center gap-6">
        ...
        <ContainerInstrument className="space-y-1">
          <HeadingInstrument level={4} className="text-primary font-black tracking-tight"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.security_mandate.b963e6" defaultText="SECURITY MANDATE" / /><TextInstrument className="text-[15px] opacity-60 font-medium"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.jouw_mailbox_bevat_g.7c640b" defaultText="Jouw mailbox bevat gevoelige klantgegevens en DNA. Door MFA te activeren, maak je de Freedom Machine ondoordringbaar voor externe dreigingen. Jouw sessie is momenteel beveiligd via Magic Link." / /></TextInstrument></HeadingInstrument>
        </ContainerInstrument>
      </ContainerInstrument>
    </PageWrapperInstrument>
  );
