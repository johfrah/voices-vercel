...
export default async function AdminEditionDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <PageWrapperInstrument className="min-h-screen pt-24 pb-32 px-6 md:px-12 max-w-[1600px] mx-auto">
      ...
      >
        <ArrowLeft strokeWidth={1.5} size={14} className="group-hover:-translate-x-1 transition-transform" /><VoiceglotText strokeWidth={1.5} translationKey="auto.page.terug_naar_studio_be.340257" defaultText="Terug naar studio beheer" / /></Link>

      <ContainerInstrument className="mb-12">
        <TextInstrument className="text-[15px] font-light tracking-widest text-black/40 mb-2"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.editie_beheer.b65194" defaultText="Editie Beheer" / /></TextInstrument>
      ...
      <BentoGrid strokeWidth={1.5} columns={3} className="gap-8">
        ...
        <BentoCard span="lg" className="bg-white shadow-aura border border-black/5 overflow-hidden">
          <ContainerInstrument className="p-8 border-b border-black/5 bg-va-off-white/50 flex justify-between items-center">
            ...
            <ButtonInstrument className="px-6 py-2 bg-black text-white text-[15px] font-light tracking-widest rounded-xl hover:bg-primary transition-all"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.bulk_audio_upload.59a817" defaultText="Bulk Audio Upload" / /></ButtonInstrument>
          </ContainerInstrument>
                  ...
                  <ContainerInstrument className="flex items-center gap-4">
                    {p.dropboxUrl ? (
                      <ContainerInstrument className="flex items-center gap-2 text-green-500 text-[15px] font-light tracking-widest">
                        <CheckCircle2 strokeWidth={1.5} size={14} /><VoiceglotText strokeWidth={1.5} translationKey="auto.page.audio_live.4d370c" defaultText="Audio Live" / /></ContainerInstrument>
                    ) : (
                      <ButtonInstrument className="flex items-center gap-2 px-4 py-3 bg-va-off-white border border-black/5 text-[15px] font-light tracking-widest rounded-xl hover:border-primary transition-all">
                        <FileAudio strokeWidth={1.5} size={14} / /><VoiceglotText strokeWidth={1.5} translationKey="auto.page.upload_audio.92cb1a" defaultText="Upload Audio" / />
                      </ButtonInstrument>
                    )}
                  </ContainerInstrument>
                </ContainerInstrument>
        ...
        <ContainerInstrument className="space-y-8">
          <BentoCard span="sm" className="bg-va-black text-white p-10">
            ...
            <HeadingInstrument level={3} className="text-xl font-light tracking-tighter mb-6"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.financi_le_afwikkeli.b40783" defaultText="Financiële Afwikkeling" / /></HeadingInstrument>
            ...
            <ContainerInstrument className="space-y-4 border-b border-white/5 pb-6 mb-6">
              <ContainerInstrument className="flex justify-between items-center">
                <TextInstrument className="text-[15px] font-light text-white/30 tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.bruto_omzet.dad5d3" defaultText="Bruto Omzet" / /></TextInstrument>
              ...
              <ContainerInstrument className="flex justify-between items-center">
                <TextInstrument className="text-[15px] font-light text-white/30 tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.platform_fee__30__.21d3ea" defaultText="Platform Fee (30%)" / /></TextInstrument>
            ...
            <ContainerInstrument className="flex justify-between items-center">
              <TextInstrument className="text-[15px] font-light text-white/30 tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.uitbetaling_instruct.1cb7e8" defaultText="Uitbetaling Instructeur" / /></TextInstrument>
            ...
            <ButtonInstrument className="w-full py-4 bg-white/5 hover:bg-white/10 rounded-xl text-[15px] font-light tracking-widest transition-all mt-10"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.bevestig_uitbetaling.386eea" defaultText="Bevestig Uitbetaling" / /></ButtonInstrument></BentoCard>
          ...
          <BentoCard span="sm" className="bg-va-off-white p-10 border border-black/5">
            ...
            <HeadingInstrument level={3} className="text-[15px] font-light tracking-widest text-black/30 mb-6"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.communicatie.637569" defaultText="Communicatie" / /></HeadingInstrument>
            <ContainerInstrument className="space-y-3">
              <ButtonInstrument className="w-full py-4 bg-white border border-black/5 text-[15px] font-light tracking-widest hover:bg-primary transition-all"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.stuur_audio_link_mai.53457f" defaultText="Stuur Audio-Link Mail" / /></ButtonInstrument><ButtonInstrument className="w-full py-4 bg-white border border-black/5 text-[15px] font-light tracking-widest hover:bg-primary transition-all"><VoiceglotText strokeWidth={1.5} translationKey="auto.page.vraag_om_review.c67197" defaultText="Vraag om Review" / /></ButtonInstrument></ContainerInstrument>
          </BentoCard>
        </ContainerInstrument>
      </BentoGrid>
    </PageWrapperInstrument>
