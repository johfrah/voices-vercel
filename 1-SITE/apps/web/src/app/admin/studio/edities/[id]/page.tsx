      ...
      <BentoGrid columns={3} className="gap-8">
        ...
        <BentoCard span="lg" className="bg-white shadow-aura border border-black/5 overflow-hidden">
          <div className="p-8 border-b border-black/5 bg-va-off-white/50 flex justify-between items-center">
            ...
            <ButtonInstrument className="px-6 py-2 bg-black text-white text-[15px] font-black tracking-widest rounded-xl hover:bg-primary transition-all">
              BULK AUDIO UPLOAD
            </ButtonInstrument>
          </div>
                ...
                <div key={p.id} className="p-8 flex flex-col md:flex-row justify-between items-center gap-6 group">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <div className="text-[15px] font-bold text-black/30 tracking-widest mt-1">
                        {user?.email}
                      </div>
                    </div>
                  </div>
        ...
        <div className="space-y-8">
          <BentoCard span="sm" className="bg-va-black text-white p-10">
            ...
            <div className="space-y-4 border-b border-white/5 pb-6 mb-6">
              <div className="flex justify-between items-center">
                <span className="text-[15px] font-bold text-white/30 tracking-widest">Bruto Omzet</span>
                <span className="text-sm font-black">€{(participants.length * parseFloat(edition.price || '0')).toLocaleString('nl-BE')}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[15px] font-bold text-white/30 tracking-widest">Platform Fee (30%)</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-[15px] font-bold text-white/30 tracking-widest">Uitbetaling Instructeur</span>
            ...
            <ButtonInstrument className="w-full py-4 bg-white/5 hover:bg-white/10 rounded-xl text-[15px] font-black tracking-widest transition-all mt-10">
          ...
          <BentoCard span="sm" className="bg-va-off-white p-10 border border-black/5">
            ...
            <div className="space-y-3">
              <ButtonInstrument className="w-full py-4 bg-white border border-black/5 text-[15px] font-black tracking-widest hover:bg-primary transition-all">
