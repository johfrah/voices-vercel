...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: <VoiceglotText strokeWidth={1.5} translationKey="admin.stats.mails" defaultText="Nieuwe Mails" / />, value: '12', icon: <Mail strokeWidth={1.5} size={20} />, trend: 'Inbox', color: 'text-blue-500', href: '/admin/mailbox' },
    { label: <VoiceglotText strokeWidth={1.5} translationKey="admin.stats.approvals" defaultText="Approval Queue" / />, value: '5', icon: <Bell strokeWidth={1.5} size={20} / />, trend: 'Actie nodig', color: 'text-orange-500', href: '/admin/approvals' },
    { label: <VoiceglotText strokeWidth={1.5} translationKey="admin.stats.voices" defaultText="Actieve Stemmen" / />, value: '142', icon: <Mic strokeWidth={1.5} size={20} / />, trend: '+12%', color: 'text-va-black/40' },
    { label: <VoiceglotText strokeWidth={1.5} translationKey="admin.stats.ai_status" defaultText="AI Sync Status" / />, value: 'Live', icon: <Activity strokeWidth={1.5} size={20} />, trend: '100%', color: 'text-green-500' },
  ];
      ...
      <SectionInstrument className="flex justify-between items-end">
        <ContainerInstrument className="space-y-2">
          <ContainerInstrument className="flex items-center gap-2 text-primary">
            ...
            <TextInstrument as="span" className="text-[15px] font-light tracking-[0.2em]"><VoiceglotText strokeWidth={1.5} translationKey="admin.badge" defaultText="Voices Cockpit" / /></TextInstrument>
          </ContainerInstrument>
          <HeadingInstrument level={1} className="text-6xl font-light tracking-tighter text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="admin.title" defaultText="Beheer-dashboard" / /></HeadingInstrument>
        </ContainerInstrument>
        <ContainerInstrument className="flex gap-4">
          <ButtonInstrument className="va-btn-nav !rounded-[10px]"><VoiceglotText strokeWidth={1.5} translationKey="admin.cta.snapshot" defaultText="Snapshot maken" / /></ButtonInstrument>
        </ContainerInstrument>
      </SectionInstrument>
      ...
      <ContainerInstrument className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {stats.map((stat, i) => (
          <ContainerInstrument key={i} className="bg-white border border-black/5 p-8 rounded-[20px] shadow-sm hover:shadow-aura transition-all group relative overflow-hidden">
            {stat.href && <Link strokeWidth={1.5} href={stat.href} className="absolute inset-0 z-10" / />}
        ...
        <ContainerInstrument className="lg:col-span-2 bg-white border border-black/5 rounded-[20px] p-10 shadow-sm">
          <ContainerInstrument className="flex justify-between items-center mb-8">
            <ContainerInstrument className="flex items-center gap-3">
              ...
              <ContainerInstrument>
                <HeadingInstrument level={2} className="text-2xl font-light tracking-tight text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="admin.feed.title" defaultText="Live intelligence feed" / /></HeadingInstrument>
                <TextInstrument className="text-[15px] text-va-black/40 font-light"><VoiceglotText strokeWidth={1.5} translationKey="admin.feed.subtitle" defaultText="Real-time meldingen van Voicy & Mailbox" / /></TextInstrument>
              </ContainerInstrument>
            </ContainerInstrument>
            <ButtonInstrument as={Link} href="/admin/mailbox" className="text-[15px] font-light tracking-widest text-primary flex items-center gap-2 hover:gap-3 transition-all"><VoiceglotText strokeWidth={1.5} translationKey="admin.feed.full_inbox" defaultText="Volledige inbox" / /><Image  src="/assets/common/branding/icons/FORWARD.svg" width={12} height={12} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / /></ButtonInstrument>
          </ContainerInstrument>
      ...
      <ContainerInstrument className="space-y-4">
        {notifications.map((n) => (
          <ContainerInstrument key={n.id} className="flex items-center justify-between p-5 bg-va-off-white rounded-[24px] border border-black/[0.02] hover:border-primary/20 transition-all group cursor-pointer">
            <ContainerInstrument className="flex items-center gap-4">
              ...
              <ContainerInstrument>
                <TextInstrument className="text-[15px] font-black text-gray-900"><VoiceglotText strokeWidth={1.5} translationKey={`admin.notification.${n.id}.title`} defaultText={n.title} noTranslate={true} / /></TextInstrument>
                <TextInstrument className="text-[15px] text-va-black/40 font-bold tracking-widest"><VoiceglotText strokeWidth={1.5} translationKey={`admin.notification.${n.id}.user`} defaultText={n.user} noTranslate={true} / /></TextInstrument>
              </ContainerInstrument>
            </ContainerInstrument>
            <ContainerInstrument className="flex items-center gap-4">
        ...
        <ContainerInstrument className="bg-va-black text-white rounded-[20px] p-10 relative overflow-hidden flex flex-col justify-between">
          <ContainerInstrument className="relative z-10">
            ...
            <HeadingInstrument level={2} className="text-3xl font-light tracking-tighter mb-4 leading-tight text-white"><VoiceglotText strokeWidth={1.5} translationKey="admin.voicy_brain.title" defaultText="Voicy Brain is aan het werk" / /><TextInstrument className="text-white/40 text-[15px] font-light leading-relaxed mb-8"><VoiceglotText strokeWidth={1.5} translationKey="admin.voicy_brain.text" defaultText="Er zijn 3 nieuwe FAQ voorstellen en 2 trend-analyses klaar om te bekijken in de mailbox." / /></TextInstrument></HeadingInstrument>
            ...
            <ContainerInstrument className="space-y-3">
              <ContainerInstrument className="flex items-center gap-3 p-3 bg-white/5 rounded-[10px] border border-white/5">
                ...
                <TextInstrument className="text-[15px] tracking-widest text-white/60 font-light"><VoiceglotText strokeWidth={1.5} translationKey="admin.voicy_brain.syncing" defaultText="Syncing Gmail..." / /></TextInstrument>
              </ContainerInstrument>
              <ContainerInstrument className="flex items-center gap-3 p-3 bg-white/5 rounded-[10px] border border-white/5">
                <ContainerInstrument className="w-2 h-2 bg-blue-500 rounded-full" />
                <TextInstrument className="text-[15px] tracking-widest text-white/60 font-light"><VoiceglotText strokeWidth={1.5} translationKey="admin.voicy_brain.analyzing" defaultText="Analyzing Trends" / /></TextInstrument>
              </ContainerInstrument>
            </ContainerInstrument>
          </ContainerInstrument>

          <ButtonInstrument as={Link} href="/admin/mailbox?tab=insights" className="relative z-10 va-btn-pro !bg-primary w-full text-center mt-8 !rounded-[10px]"><VoiceglotText strokeWidth={1.5} translationKey="admin.voicy_brain.cta" defaultText="Bekijk intelligence" / /></ButtonInstrument>
      ...
      <BentoGrid strokeWidth={1.5} columns={3}>
        ...
        <BentoCard span="lg" className="bg-va-black text-white p-12 h-[400px] flex flex-col justify-between relative overflow-hidden group">
          <ContainerInstrument className="relative z-10">
            ...
            <HeadingInstrument level={2} className="text-4xl font-black tracking-tighter mb-4"><VoiceglotText strokeWidth={1.5} translationKey="admin.database.title" defaultText="Database Manager" / /><TextInstrument className="text-white/40 max-w-sm text-[15px] font-medium leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="admin.database.text" defaultText="Beheer alle records (Stemmen, Reviews, Workshops) direct in de cloud. 100% visuele interface." / /></TextInstrument></HeadingInstrument>
          </ContainerInstrument>
          <Link strokeWidth={1.5} href="/admin/database" className="relative z-10 va-btn-pro !bg-primary w-fit"><VoiceglotText strokeWidth={1.5} translationKey="admin.database.cta" defaultText="Open Database" / /></Link>
        ...
        <BentoCard span="sm" className="bg-white border border-black/5 p-10 flex flex-col justify-between h-[400px] group hover:border-primary/20 transition-all rounded-[20px]">
          <ContainerInstrument>
            ...
            <HeadingInstrument level={2} className="text-2xl font-light tracking-tight mb-4 text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="admin.settings.title" defaultText="Systeem instellingen" / /><TextInstrument className="text-va-black/40 text-[15px] font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="admin.settings.text" defaultText="Configureer bedrijfsinformatie, openingsuren en de globale vakantieregeling." / /></TextInstrument></HeadingInstrument>
          </ContainerInstrument>
          <Link strokeWidth={1.5} href="/admin/settings" className="text-[15px] font-light tracking-widest text-primary flex items-center gap-2 group-hover:gap-4 transition-all">
            <VoiceglotText strokeWidth={1.5} translationKey="admin.settings.cta" defaultText="Beheer instellingen" / />
        ...
        <BentoCard span="sm" className="bg-va-off-white p-10 flex flex-col justify-between h-[400px] border border-black/5 group hover:border-primary/20 transition-all rounded-[20px]">
          <ContainerInstrument>
            <Image  src="/assets/common/branding/icons/INFO.svg" width={32} height={32} alt="" className="text-va-black/20 group-hover:text-primary transition-colors mb-8" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
            <HeadingInstrument level={2} className="text-2xl font-light tracking-tight mb-4 text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="admin.architect.title" defaultText="Page architect" / /><TextInstrument className="text-va-black/40 text-[15px] font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="admin.architect.text" defaultText="Beheer je bento blueprints en maak nieuwe landingspagina's aan via de visuele builder." / /></TextInstrument></HeadingInstrument>
          </ContainerInstrument>
          <Link strokeWidth={1.5} href="/" className="text-[15px] font-light tracking-widest text-va-black/40 hover:text-va-black transition-colors"><VoiceglotText strokeWidth={1.5} translationKey="admin.architect.cta" defaultText="Naar frontend builder" / /></Link>
        </BentoCard>
        ...
        <BentoCard span="lg" className="bg-white border border-black/5 p-12 h-[400px] flex flex-col justify-between group hover:border-primary/20 transition-all rounded-[20px]">
          <ContainerInstrument className="flex justify-between items-start">
            <ContainerInstrument>
              <Image  src="/assets/common/branding/icons/INFO.svg" width={32} height={32} alt="" className="text-va-black/20 group-hover:text-primary transition-colors mb-8" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tighter mb-4 text-va-black"><VoiceglotText strokeWidth={1.5} translationKey="admin.users.title" defaultText="User DNA" / /><TextInstrument className="text-va-black/40 max-w-sm text-[15px] font-light leading-relaxed"><VoiceglotText strokeWidth={1.5} translationKey="admin.users.text" defaultText="Beheer klanten, rollen en journey-states. Bekijk AI-insights over bezoekergedrag." / /></TextInstrument></HeadingInstrument>
            </ContainerInstrument>
            <ContainerInstrument className="flex flex-col items-end gap-2">
              <Link strokeWidth={1.5} href="/admin/marketing/visitors" className="px-4 py-2 bg-green-500/10 text-green-500 rounded-[20px] text-[15px] font-light hover:bg-green-500/20 transition-all"><VoiceglotText strokeWidth={1.5} translationKey="admin.users.online_count" defaultText="8 online" / /></Link>
            </ContainerInstrument>
          </ContainerInstrument>
          <ButtonInstrument className="va-btn-pro !bg-va-black w-fit !rounded-[10px]"><VoiceglotText strokeWidth={1.5} translationKey="admin.users.cta" defaultText="Gebruikers beheren" / /></ButtonInstrument>
        </BentoCard>
        ...
        <BentoCard span="sm" className="bg-va-black text-white p-10 h-[400px] flex flex-col justify-between relative overflow-hidden group rounded-[20px]">
          <ContainerInstrument className="relative z-10">
            ...
            <HeadingInstrument level={2} className="text-2xl font-light tracking-tight mb-6 text-white"><VoiceglotText strokeWidth={1.5} translationKey="admin.self_healing.title" defaultText="Self-healing logs" / /></HeadingInstrument>
            ...
            <ContainerInstrument className="space-y-4">
              {recentHeals.length > 0 ? recentHeals.map((heal, i) => (
                ...
                <TextInstrument className="text-[15px] tracking-widest text-white/20 font-light"><VoiceglotText strokeWidth={1.5} translationKey="admin.self_healing.empty" defaultText="Geen recente herstelacties." / /></TextInstrument>
              )}
            </ContainerInstrument>
          </ContainerInstrument>
          
          <Link strokeWidth={1.5} href="/admin/security" className="relative z-10 text-[15px] font-light tracking-widest text-primary hover:underline"><VoiceglotText strokeWidth={1.5} translationKey="admin.self_healing.view_all" defaultText="Bekijk alle logs" / /></Link>
