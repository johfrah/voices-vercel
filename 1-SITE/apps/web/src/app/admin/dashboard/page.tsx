    ...
    <PageWrapperInstrument className="p-12 space-y-12 max-w-[1600px] mx-auto">
      ...
      <SectionInstrument className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <ContainerInstrument className="lg:col-span-2 bg-white border border-black/5 rounded-[20px] p-10 shadow-sm">
          <ContainerInstrument className="flex justify-between items-center mb-8">
            ...
            <ButtonInstrument as={Link} href="/admin/mailbox" className="text-[15px] font-light tracking-widest text-primary flex items-center gap-2 hover:gap-3 transition-all"><VoiceglotText translationKey="admin.feed.full_inbox" defaultText="Volledige inbox" /><Image strokeWidth={1.5} src="/assets/common/branding/icons/FORWARD.svg" width={12} height={12} alt="" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / /></ButtonInstrument>
          </ContainerInstrument>
      ...
      <BentoGrid columns={3}>
        ...
        <BentoCard span="lg" className="bg-va-black text-white p-12 h-[400px] flex flex-col justify-between relative overflow-hidden group">
          ...
          <Link strokeWidth={1.5} href="/admin/database" className="relative z-10 va-btn-pro !bg-primary w-fit"><VoiceglotText translationKey="admin.database.cta" defaultText="Open Database" /></Link>
        ...
        <BentoCard span="sm" className="bg-white border border-black/5 p-10 flex flex-col justify-between h-[400px] group hover:border-primary/20 transition-all rounded-[20px]">
          <ContainerInstrument>
            <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={32} height={32} alt="" className="text-va-black/20 group-hover:text-primary transition-colors mb-8" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
        ...
        <BentoCard span="sm" className="bg-va-off-white p-10 flex flex-col justify-between h-[400px] border border-black/5 group hover:border-primary/20 transition-all rounded-[20px]">
          ...
          <Link strokeWidth={1.5} href="/" className="text-[15px] font-light tracking-widest text-va-black/40 hover:text-va-black transition-colors"><VoiceglotText translationKey="admin.architect.cta" defaultText="Naar frontend builder" /></Link>
        </BentoCard>
        ...
        <BentoCard span="lg" className="bg-white border border-black/5 p-12 h-[400px] flex flex-col justify-between group hover:border-primary/20 transition-all rounded-[20px]">
          <ContainerInstrument className="flex justify-between items-start">
            ...
            <ContainerInstrument className="flex flex-col items-end gap-2">
              <Link strokeWidth={1.5} href="/admin/marketing/visitors" className="px-4 py-2 bg-green-500/10 text-green-500 rounded-[20px] text-[15px] font-light hover:bg-green-500/20 transition-all"><VoiceglotText translationKey="admin.users.online_count" defaultText="8 online" /></Link>
            </ContainerInstrument>
          </ContainerInstrument>
        ...
        <BentoCard span="sm" className="bg-va-black text-white p-10 h-[400px] flex flex-col justify-between relative overflow-hidden group rounded-[20px]">
          <ContainerInstrument className="relative z-10">
            <Image strokeWidth={1.5} src="/assets/common/branding/icons/INFO.svg" width={32} height={32} alt="" className="text-primary mb-8 brightness-0 invert opacity-20" style={{ filter: 'invert(18%) sepia(91%) saturate(6145%) hue-rotate(332deg) brightness(95%) contrast(105%)' }} / />
          ...
          <Link strokeWidth={1.5} href="/admin/security" className="relative z-10 text-[15px] font-light tracking-widest text-primary hover:underline"><VoiceglotText translationKey="admin.self_healing.view_all" defaultText="Bekijk alle logs" /></Link>
