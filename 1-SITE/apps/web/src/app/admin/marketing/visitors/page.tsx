    ...
    <PageWrapperInstrument className="p-12 space-y-12 max-w-[1600px] mx-auto">
      ...
      <SectionInstrument className="flex justify-between items-end">
        ...
        <ContainerInstrument className="flex gap-4 bg-va-black text-white p-6 rounded-[24px] border border-white/5">
          <div className="flex flex-col">
            <span className="text-[10px] font-black uppercase tracking-widest text-white/40">Live Bezoekers</span>
            <span className="text-3xl font-black text-primary">{visitors.length}</span>
          </div>
          <div className="w-px h-full bg-white/10 mx-4" />
          <div className="flex flex-col">
            <span className="text-[10px] font-black uppercase tracking-widest text-white/40">Sessies Vandaag</span>
      ...
      <SectionInstrument className="bg-white border border-black/5 rounded-[40px] overflow-hidden shadow-sm">
        <div className="p-8 border-b border-black/5 flex justify-between items-center">
          <HeadingInstrument level={2} className="text-xl font-black uppercase tracking-tight">
            <VoiceglotText translationKey="admin.visitors.table_title" defaultText="Intelligence Playlist" />
          </HeadingInstrument>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
              <span className="text-[10px] font-black uppercase tracking-widest text-va-black/40">{visitors.length} Live</span>
            </div>
            <div className="w-px h-4 bg-black/10" />
            <span className="text-[10px] font-black uppercase tracking-widest text-va-black/20">{recentSessions.length} Recent</span>
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-va-off-white">
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-va-black/40">Bezoeker</th>
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-va-black/40">Status</th>
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-va-black/40">Huidige Pagina</th>
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-va-black/40">Duur</th>
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-va-black/40">Events</th>
                <th className="p-6 text-[10px] font-black uppercase tracking-widest text-va-black/40 text-right">Actie</th>
              </tr>
            </thead>
                ...
                <tr>
                  <td colSpan={6} className="p-20 text-center">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <span className="text-xs font-bold uppercase tracking-widest text-va-black/20">Laden van data...</span>
                    </div>
                  </td>
                </tr>
                ...
                recentSessions.map((v) => {
                  ...
                  return (
                    <tr key={v.id} className="hover:bg-va-off-white transition-colors group">
                      <td className="p-6">
                        <div className="flex items-center gap-4">
                          <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center font-black text-xs", isLive ? "bg-va-black text-white" : "bg-va-black/5 text-va-black/40")}>
                          ...
                          <div>
                            ...
                            <TextInstrument className="text-[10px] text-va-black/40 font-bold uppercase tracking-widest">
                      ...
                      <td className="p-6">
                        {isLive ? (
                          ...
                          <div className="text-va-black/20 text-[10px] font-black uppercase">
                            Voltooid
                          </div>
                        )}
                      </td>
                      <td className="p-6">
                        <div className="flex items-center gap-2 text-xs font-bold bg-va-black/5 px-3 py-1.5 rounded-lg w-fit max-w-[200px] truncate">
                      ...
                      <td className="p-6 text-right">
                        <Link 
                          ...
                          className="inline-flex items-center gap-2 bg-va-black text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-primary transition-all group-hover:scale-105"
                        >
                          <PlayCircle size={14} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <ContainerInstrument className="bg-va-black text-white p-10 rounded-[40px] relative overflow-hidden">
          ...
          <TextInstrument className="text-white/40 text-xs font-medium leading-relaxed mb-6">
            Meest geklikte elementen in de laatste 24 uur. Focus op de &apos;Tarieven&apos; knop bij Agency.
          </TextInstrument>
          <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-primary flex items-center gap-2">
        ...
        <ContainerInstrument className="bg-white border border-black/5 p-10 rounded-[40px]">
          ...
          <TextInstrument className="text-va-black/40 text-xs font-medium leading-relaxed mb-6">
            80% van de huidige bezoekers zijn &apos;Decision Makers&apos; binnen de Agency journey.
          </TextInstrument>
          <Link href="/admin/users" className="text-[10px] font-black uppercase tracking-widest text-va-black/40 flex items-center gap-2">
        ...
        <ContainerInstrument className="bg-va-off-white border border-black/5 p-10 rounded-[40px]">
          ...
          <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-va-black/40 flex items-center gap-2">
