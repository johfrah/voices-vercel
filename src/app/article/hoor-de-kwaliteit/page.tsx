    ...
    <PageWrapperInstrument className="relative min-h-screen pt-32 pb-20 overflow-hidden">
      ...
      <SectionInstrument className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <BentoGrid columns={4}>
          {topVoices.map((voice, i) => (
            ...
            >
              <ContainerInstrument className="aspect-[4/5] relative">
                <div className="absolute inset-0 bg-va-off-white animate-pulse" />
          ...
          >
            <ContainerInstrument>
              <Mic size={40} className="mb-6 opacity-20" />
              <HeadingInstrument level={2} className="text-4xl font-black uppercase tracking-tight mb-4">
