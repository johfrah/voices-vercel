        ...
        <BentoGrid columns={3}>
          ...
          >
            <div className="w-24 h-24 rounded-full bg-white/10 flex items-center justify-center shrink-0 animate-pulse">
              <Music size={48} className="text-white" strokeWidth={1.5} />
            </div>
            <ContainerInstrument className="space-y-6">
              <HeadingInstrument level={2} className="text-4xl font-light tracking-tight uppercase">
          ...
          <BentoCard span="md" className="bg-white shadow-aura p-12 !rounded-[20px]">
            ...
            <HeadingInstrument level={3} className="text-2xl font-light tracking-tight mb-4 text-va-black uppercase">
