            ...
            <ContainerInstrument className="space-y-8">
              ...
              <TextInstrument className="text-va-black/60 font-medium text-lg leading-relaxed">
                <VoiceglotText 
                  ...
                  defaultText="Voices is ontstaan uit een passie voor audio en menselijke connectie. In een wereld die steeds digitaler wordt, is de menselijke stem het krachtigste instrument om echt contact te maken." 
                />
              </TextInstrument>
            </ContainerInstrument>
          </BentoCard>
