...
const STATUS_ALIAS_MAP: Record<string, string[]> = {
  ...
  in_productie: ['completed_unpaid', 'awaiting_payment', 'waiting_po'],
  in_progress: ['completed_unpaid', 'awaiting_payment', 'waiting_po'],
  awaiting_payment: ['awaiting_payment', 'pending', 'unpaid', 'waiting_po', 'wc-pending'],
  pending: ['awaiting_payment', 'pending', 'unpaid', 'waiting_po', 'wc-pending'],
  waiting_po: ['waiting_po', 'awaiting_payment', 'pending', 'unpaid'],
  quote_pending: ['quote_sent', 'quote_pending', 'quote-pending'],
