...
export const BriefingSelector: React.FC<BriefingSelectorProps> = ({ onScriptExtracted }) => {
  ...
  return (
    <ContainerInstrument 
      as={motion.div}
      {...({ initial: { opacity: 0, height: 0 }, animate: { opacity: 1, height: 'auto' }, exit: { opacity: 0, height: 0 } } as any)}
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {extractedPreview ? (
          <ContainerInstrument
            as={motion.div}
            {...({ initial: { opacity: 0, scale: 0.95 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 0.95 } } as any)}
          ...
          <ContainerInstrument 
            as={motion.div}
            {...({ initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: 10 } } as any)}
