...
const WorkshopCarousel = nextDynamic(() => import("./WorkshopCarousel").then(mod => mod.WorkshopCarousel), { ssr: false });
const ReviewGrid = nextDynamic(() => import("./ReviewGrid").then(mod => mod.ReviewGrid), { ssr: false });
                ...
                <ContainerInstrument className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                  <ContainerInstrument className="flex items-center gap-8">
                    ...
                    {edition.workshopImagePath ? (
                      <ContainerInstrument className="relative w-24 h-24 rounded-[18px] overflow-hidden border border-black/5 group-hover:border-white/20 transition-colors shrink-0">
                        <Image 
                      ...
                      <ContainerInstrument className="w-24 h-24 bg-va-off-white group-hover:bg-white/10 rounded-[18px] flex flex-col items-center justify-center transition-colors shrink-0">
                        <TextInstrument className="text-[11px] font-bold uppercase tracking-widest text-va-black/30 group-hover:text-white/40">
                  ...
                  <ContainerInstrument className="flex items-center gap-6">
                    <ContainerInstrument className="px-4 py-2 bg-va-off-white/80 group-hover:bg-white/10 rounded-full transition-colors">
                      <TextInstrument as="span" className="text-[11px] font-bold tracking-widest uppercase text-va-black/50 group-hover:text-white/80">
