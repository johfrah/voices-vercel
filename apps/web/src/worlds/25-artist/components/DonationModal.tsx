      ...
      <ContainerInstrument className="bg-white w-full max-w-md rounded-[20px] shadow-aura-lg overflow-hidden relative animate-in fade-in zoom-in duration-300">
        ...
        <ContainerInstrument className="p-10">
          ...
          <HeadingInstrument level={2} className="text-3xl font-black uppercase tracking-tight mb-2">
            <VoiceglotText translationKey="donation.title" defaultText="Support the artist" />
          </HeadingInstrument>
          <TextInstrument className="text-va-black/40 font-medium mb-8">
            <VoiceglotText translationKey="donation.description" values={{ name: artistName }} defaultText={`Help ${artistName} realize his first EP.`} />
          </TextInstrument>
            ...
            <ContainerInstrument className="bg-va-off-white p-6 rounded-[15px] border border-black/[0.03] flex justify-between items-center">
              <ContainerInstrument>
                <TextInstrument className="text-[10px] font-black uppercase tracking-[0.2em] text-va-black/30 mb-1">
                  <VoiceglotText translationKey="donation.selected_amount" defaultText="Selected amount" />
                </TextInstrument>
              ...
              >
                <VoiceglotText translationKey="common.change" defaultText="Change" />
              </ButtonInstrument>
            </ContainerInstrument>

            <ContainerInstrument className="space-y-4 pt-4 border-t border-black/[0.03]">
              <ContainerInstrument className="flex items-center gap-3 px-4 py-2 bg-va-off-white rounded-[10px] border border-black/[0.02]">
                <input 
                  type="checkbox" 
                  id="anonymous" 
                  checked={isAnonymous}
                ...
                />
                <LabelInstrument htmlFor="anonymous" className="text-[11px] font-black uppercase tracking-widest text-va-black/40 cursor-pointer">
                  <VoiceglotText translationKey="donation.anonymous" defaultText="Donate anonymously" />
                </LabelInstrument>
              </ContainerInstrument>
              ...
              >
                {loading ? (
                  ...
                  <>
                    ...
                    <VoiceglotText translationKey="donation.action.donate_amount" values={{ amount }} defaultText={`Donate €${amount} now`} />
                  </>
                )}
              </ButtonInstrument>
              <TextInstrument className="text-[9px] text-va-black/20 font-medium text-center uppercase tracking-widest leading-relaxed">
                <VoiceglotText translationKey="donation.footer.secure" defaultText="Secure via Bancontact, Card, Apple Pay" /><br/>
                <VoiceglotText translationKey="donation.footer.pure" defaultText="Pure donation • No goods or services in return" />
              </TextInstrument>
            </ContainerInstrument>
          </ContainerInstrument>
        </ContainerInstrument>
