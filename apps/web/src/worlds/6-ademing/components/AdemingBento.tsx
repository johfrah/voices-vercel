...
import { VoicesDropdown } from '@/components/ui/VoicesDropdownInstrument';
import { ElementIcon } from './ElementIcon';
import { MarketManagerServer as MarketManager } from "@/lib/system/core/market-manager";
import { ContainerInstrument, HeadingInstrument, TextInstrument, SectionInstrument } from '@/components/ui/LayoutInstruments';
      ...
      <ContainerInstrument plain>
        ...
        <ContainerInstrument className="max-w-6xl mx-auto px-6 space-y-40 py-32">
          ...
          <SectionInstrument className="animate-fade-in text-center space-y-12" style={{ animationDelay: '0.1s' }}>
            <ContainerInstrument className="max-w-3xl mx-auto space-y-8">
          ...
          <SectionInstrument className="animate-fade-in py-16" style={{ animationDelay: '0.3s' }}>
            <ContainerInstrument className="max-w-4xl mx-auto space-y-16">
              <ContainerInstrument className="text-center space-y-6">
