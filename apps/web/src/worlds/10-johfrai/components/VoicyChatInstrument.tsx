...
import { ButtonInstrument, ContainerInstrument, FormInstrument, HeadingInstrument, InputInstrument, LabelInstrument, TextInstrument } from '@/components/ui/LayoutInstruments';
                  ...
                  {isInitialLoading ? (
                    ...
                    <>
                      ...
                      {isTyping && (
                        <ContainerInstrument
                          as={motion.div}
                          {...({ initial: { opacity: 0, y: 5 }, animate: { opacity: 1, y: 0 } } as any)}
