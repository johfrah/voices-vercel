      ...
      <ContainerInstrument className="space-y-4">
        ...
        <ContainerInstrument className="flex flex-wrap gap-3">
          {SECTORS.map((sector) => (
            ...
            >
              <ContainerInstrument plain className={cn("p-2 rounded-lg", selectedSector === sector.id ? "bg-white/20" : sector.color + " text-white")}>
                <sector.icon size={16} />
              </ContainerInstrument>
      ...
      <ContainerInstrument className="space-y-4">
        ...
        <ContainerInstrument className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <AnimatePresence  mode="popLayout">
            {isLoading ? (
              <ContainerInstrument className="col-span-full py-12 flex flex-col items-center justify-center text-va-black/20 space-y-4">
                <ContainerInstrument plain className="w-8 h-8 border-4 border-va-black/10 border-t-primary rounded-full animate-spin" />
                ...
                >
                  <ContainerInstrument className="flex items-center gap-4">
                    <ButtonInstrument
                      ...
                      className={cn(
                        "w-12 h-12 rounded-2xl flex items-center justify-center transition-all p-0",
              ...
              <ContainerInstrument className="col-span-full py-12 flex flex-col items-center justify-center text-va-black/20 space-y-4 bg-va-black/5 rounded-[32px] border-2 border-dashed border-va-black/10">
