      ...
      <ContainerInstrument className="flex gap-4">
        {!isPreviewMode ? (
          <>
            ...
            <ButtonInstrument as={Link} href={`/academy/lesson/${lessonId}?preview=student`} className="va-btn-pro !bg-white/10 !text-white !py-2 !px-4 !text-[15px] hover:!bg-white/20">
              <VoiceglotText translationKey="auto.page.preview_als_student.9f9b1c" defaultText="Preview als Student" />
            </ButtonInstrument>
          </>
        ) : (
          <ButtonInstrument as={Link} href={`/academy/lesson/${lessonId}`} className="va-btn-pro !py-2 !px-4 !text-[15px]">
