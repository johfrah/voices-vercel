...
import { GlossaryTooltip } from '@/components/ui/GlossaryTooltipInstrument';
...
export const AcademyContent: React.FC<AcademyContentProps> = ({ 
  ...
  const processedContent = useMemo(() => {
    if (glossary.length === 0) return <ContainerInstrument dangerouslySetInnerHTML={{ __html: rawContent }} />;
