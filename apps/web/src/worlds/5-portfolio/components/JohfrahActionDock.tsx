...
import { ButtonInstrument, TextInstrument, FixedActionDockInstrument, ContainerInstrument } from "@/components/ui/LayoutInstruments";
...
export function JohfrahActionDock() {
  ...
  return (
    <FixedActionDockInstrument className="md:hidden">
      ...
      <ContainerInstrument plain className="w-px h-8 bg-black/5" />
