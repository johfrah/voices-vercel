  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <ContainerInstrument plain className="sticky top-0 left-0 right-0 z-[310] bg-white/80 backdrop-blur-xl border-b border-black/5 p-4 flex justify-between items-center">
          <ContainerInstrument className="flex items-center gap-4">
            ...
            <HeadingInstrument level={3} className="text-lg font-light tracking-tighter">
              <VoiceglotText translationKey="portfolio.configurator.title" defaultText="Start je project met Johfrah" />
            </HeadingInstrument>
          </ContainerInstrument>
          <ContainerInstrument className="flex items-center gap-4">
        ...
        <ContainerInstrument className="max-w-7xl mx-auto py-12 px-6">
          {state.step === 'briefing' ? (
            ...
            <ContainerInstrument className="animate-in fade-in slide-in-from-bottom-4 duration-700">
              <CheckoutPageClient />
              <MobileCheckoutSheet />
            </ContainerInstrument>
          )}
