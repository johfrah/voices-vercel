            ...
            {!hideButton && (
              <ButtonInstrument 
                ...
                className={cn(
                  ...
                  (voice as any).allow_free_trial === false && !onSelect && "opacity-0 pointer-events-none"
                )}
              >
