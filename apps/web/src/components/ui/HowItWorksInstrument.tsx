  ...
  return (
    <ContainerInstrument id="how-it-works" className="mb-32 scroll-mt-32">
      ...
      <ContainerInstrument className="mb-16 space-y-4">
        ...
        <TextInstrument as="span" className="hmagic-text font-light italic text-5xl tracking-tighter">
          <VoiceglotText  translationKey="home.steps.title_highlight" defaultText="beste" />
        </TextInstrument>
        <HeadingInstrument level={2} className="text-5xl font-light tracking-tighter inline">
        ...
        {steps.map((step: any, i: number) => (
          <ContainerInstrument key={i} className="space-y-6 group">
            ...
            <ContainerInstrument>
              ...
              <TextInstrument className="text-[15px] text-va-black/50 font-medium leading-relaxed">
