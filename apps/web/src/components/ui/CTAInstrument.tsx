  ...
  return (
    <BentoCard span="full" className="bg-va-black text-white p-20 text-center relative overflow-hidden group mb-20 hmagic">
      ...
      <ContainerInstrument className="relative z-10 space-y-8">
        ...
        <TextInstrument className="text-xl text-white/40 max-w-2xl mx-auto font-medium"><VoiceglotText  translationKey="home.cta.subtitle" defaultText="Sluit je aan bij honderden bedrijven die hun merk versterken." /></TextInstrument>
        <ContainerInstrument className="flex justify-center gap-6 pt-4">
          <Link  href="/" className="va-btn-pro !px-12 !py-6 text-lg !bg-primary"><VoiceglotText  translationKey="home.cta.primary" defaultText="Vind jouw stem" /></Link>
