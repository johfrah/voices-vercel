...
| 133 | **Nuclear Content Migration** | 1. Scan `docs/archive/`. 2. Categoriseer per journey. 3. Injecteer alles in Supabase. | "De Kelder is leeg. Alle grondstoffen zijn getransformeerd en staan nu in de Etalage." | File Scan, AI Categorizer, Supabase Write |
