...
- **v2.28.0**: OpenAI proxy volledig verwijderd. Documentatie gezuiverd van WordPress/PHP slop.
- **v2.28.1**: SWOT-analyse en Cursor Evolution Plan geïntegreerd.
- **v2.28.2**: Legacy rootmappen uitgefaseerd; `docs/` + `scripts/` zijn de enige operationele paden.
