...
1.  **apps/**: De motor (Next.js, Supabase, Drizzle).
2.  **docs/**: De controlekamer (Blueprints, specs en referentie).
3.  **scripts/** + **docs/archive/**: Automatisatie en archief (legacy, grondstoffen).
...
3.  `npx tsx scripts/forensic-audit.ts` volledig groen is.
...
3.  `docs/3-TECHNICAL-SPECS/310-LAYOUT-INSTRUMENTS.mdc`: Je UI-gereedschapskist.
