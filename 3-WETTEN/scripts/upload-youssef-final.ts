...
// Verhoogde timeout voor grote bestanden
...
async function uploadWithHighTimeout() {
  console.log("🚀 STARTING HIGH-TIMEOUT UPLOAD FOR YOUSSEF VIDEO (Chris-Protocol)");
